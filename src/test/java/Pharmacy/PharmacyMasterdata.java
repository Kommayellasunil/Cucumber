...
//		driver.manage().window().maximize();
	...
	public void enter_email2_password2(String email2, String password2) throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("user_login"))).sendKeys(email2);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("user_password"))).sendKeys(password2);
		Thread.sleep(5000);
	}
	...
	public void selecting_the_profile_as_pharmacist_after_selecting_the_cdp() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[normalize-space(text())='Pharmacist - Test Pharmacy'])[1]"))).click();
		Thread.sleep(3000);
	...
	public void click_on_the_brandmaster() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("add"))).click();
		Thread.sleep(1000);
	}
	...
	public void enter_the_details_after_brandmaster_creation_popup_opens() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//label[text()='Category'])[2]/following-sibling::span[1]"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
...
//		driver.findElement(By.xpath("(//label[text()='Form'])[2]/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='Tablet'][1]"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#brand_master_brand_name"))).sendKeys("Pharmacybrandmastertest");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#brand_master_brand_desc"))).sendKeys("NA");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//label[text()='Route'])[1]/following-sibling::span[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//li[text()='Oral'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='brand_master_tax_service_mapping_master_attributes_hsncode']")))
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='brand_master_mrp']"))).sendKeys("200");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='brand_master_mrp']"))).sendKeys(Keys.PAGE_DOWN);
		Thread.sleep(1000);
		for (int i = 0; i <= 2; i++) {
...
//		Thread.sleep(1000);		
	...
	public void edit_and_save_the_changes_for_the_brandmaster() throws Exception {
		...
		Thread.sleep(2000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#brand_master_brand_desc"))).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#brand_master_brand_desc"))).sendKeys("Test salt name");
		Thread.sleep(1000);
		// save
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@value='Save'][1]"))).click();
		Thread.sleep(5000);
	...
	public void fillup_the_details_and_upload_the_medicinetype_img_and_save() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#medicine_type_master_medicine_type_name")))
				.sendKeys("Cucum medicinetype");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		// selecting the start date
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#medicine_type_master_effctv_dt"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		// 18
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[text()='1']"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		// selecting the end date
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#medicine_type_master_trmntn_dt"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='selects-container'])[2]/div[2]/input"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		// 2026
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/ul[3]/li[14]"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		// apr 1
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//button[text()='1'])[2]"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	...
	public void edit_and_save_the_changes_for_the_medicinetype() throws Exception {
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//li[text()='Cucum medicinetype'])[1]"))).click();
		Thread.sleep(1000);
	...
	public void fillup_the_details_and_save_the_manufacturer() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("manufacturer_master_manufacturer_name"))).sendKeys("Cucum maunfacturer");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// entering the description
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("manufacturer_master_desc"))).sendKeys("demo description");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// clicking on the save button
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/main/div/div[3]/div/div[2]/form/div[2]/input[1]"))).click();
		Thread.sleep(5000);
	}
	...
	public void edit_and_save_the_changes_for_the_manufacturer() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//i[@class='fa fa-pencil'])[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("manufacturer_master_desc"))).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("manufacturer_master_desc"))).sendKeys("demo desc.");
		Thread.sleep(1000);
		// clicking on the save button
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/main/div/div[3]/div/div[2]/form/div[2]/input[1]"))).click();
		Thread.sleep(3000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#q_manufacturer_name_cont"))).sendKeys("Cucum");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@value='Search'])[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[text()='Reset'])[1]"))).click();
	...
	public void fillup_the_details_and_upload_the_header_footers_for_distributor_and_save() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("check_name"))).sendKeys("Cucum distributor");
//		Thread.sleep(1000);
		// entering the license code
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("check_code"))).sendKeys("PH12345");
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		// address line 1
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("address_details_address_line1"))).sendKeys("demo");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// address line 2
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("address_details_address_line2"))).sendKeys("address");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// area
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("address_details_area"))).sendKeys("demo area");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// landamrk
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("address_details_landmark"))).sendKeys("demolandmark");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// city
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//label[text()='City'])[1]/preceding-sibling::span[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[text()='Hyderabad'][1]"))).click();
		Thread.sleep(1000);
		// pincode
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("address_details_pin_code"))).sendKeys("500032");
		Thread.sleep(1000);
		// phonetype
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("contact_details_phn_nmbr_typ"))).sendKeys("phone");
		Thread.sleep(1000);
		// country
		...
		Thread.sleep(1000);
		// phonenumber
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("contact_details_nmbr"))).sendKeys("7654334128");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// gmail
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("contact_details_email"))).sendKeys("testdistribu1@gmail.com");
		Thread.sleep(1000);
		// save
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/main/div[2]/div/div[2]/form/fieldset[2]/div/input[1]"))).click();
		Thread.sleep(5000);
	...
	public void edit_and_save_the_changes_for_the_distributor() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[@class='selection'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//li[text()='Cucum distributor'])[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@value='Search'])[1]"))).click();
		Thread.sleep(3000);
		// edit
		...
		Thread.sleep(2000);
		// adding GST Number
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#pharmacy_master_gst_no"))).sendKeys("27AAAAA1234A1Z5");
		Thread.sleep(2000);
		// save
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/main/div[2]/div/div[2]/form/fieldset[2]/div/input[1]"))).click();
		Thread.sleep(5000);

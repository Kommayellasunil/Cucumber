...
//		driver.manage().window().maximize();
	...
	public void select_the_cdp_and_clinic_manager_role() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[normalize-space(text())='Clinic_Manager - NanoHealth_OPD'])[1]")))
				.click();
		Thread.sleep(5000);
	}
	...
	public void clicking_on_the_billing_and_select_the_patientwisereport1() throws Exception {
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='revenue_report'])[1]"))).click();
		Thread.sleep(3000);
	}
...
//				.click();
	...
	public void clicking_on_the_billing_and_select_the_doctorwisereport() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-billing-tab'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='doctorWise_report'])[1]"))).click();
		Thread.sleep(3000);
	}
...
//		Thread.sleep(1000);
	...
	public void clicking_on_the_billing_and_select_the_dueamountreport1() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-billing-tab'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='dueAmount_report'])[1]"))).click();
		Thread.sleep(3000);
	}
...
//		Thread.sleep(1000);
	...
	public void clicking_on_the_billing_and_select_the_ipreport() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-billing-tab'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='ip_report'])[1]"))).click();
		Thread.sleep(3000);
	}
...
//		Thread.sleep(3000);
	...
	public void clicking_on_the_billing_and_select_the_labpayout() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.id("admin-billing-tab"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.id("lab_payout_report"))).click();
		Thread.sleep(3000);
	}
...
//				Thread.sleep(1000);
	...
	public void clicking_on_the_billing_and_select_the_refundreport() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.id("admin-billing-tab"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.id("refund_report"))).click();
		Thread.sleep(3000);
	}
...
////				Thread.sleep(2000);
	...
	public void clicking_on_the_billing_and_select_the_promocodetracking() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.id("admin-billing-tab"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.id("promo_code_tracking-headers"))).click();
		Thread.sleep(1000);
	}

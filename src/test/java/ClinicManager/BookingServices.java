...
//		driver.manage().window().maximize();
	...
	public void login_with_sunilcm_gmail_com_and_demo(String emailid, String password) throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("user_login"))).sendKeys(emailid);
	...
	public void deleting_existing_patient_using_search() throws Exception {
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("frst_nm"))).sendKeys("7789110017");
	...
	public void select_title_of_patient() throws Exception {
		...
		addpatinet.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[@class='selection'])[1]")))
				.click();
		Thread.sleep(1000);
...
//				Thread.sleep(1000);
	...
	public void user_enters_the_following_details_into_the_registration_form(
		...
		// firstname
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.id("first_name"))).sendKeys(regData.get(0).get(1));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// lastname
		wait.until(ExpectedConditions.elementToBeClickable(By.id("lst_name"))).sendKeys(regData.get(1).get(1));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// age
		wait.until(ExpectedConditions.elementToBeClickable(By.id("age"))).sendKeys(regData.get(2).get(1));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		// phone
		wait.until(ExpectedConditions.elementToBeClickable(By.id("nmbr"))).sendKeys(regData.get(3).get(1));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// email
//		driver.findElement(By.id("email")).sendKeys(regData.get(4).get(1));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// addressline
		wait.until(ExpectedConditions.elementToBeClickable(By.id("address-line1"))).sendKeys(regData.get(4).get(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.id("autocomplete-input"))).sendKeys(regData.get(5).get(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.id("landmark"))).sendKeys(regData.get(6).get(1));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='city'])[1]"))).sendKeys(regData.get(7).get(1));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// district
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='district'])[1]"))).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='district'])[1]"))).sendKeys(regData.get(8).get(1));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// pincode
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='pn_cd'])[1]"))).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='pn_cd'])[1]"))).sendKeys(regData.get(9).get(1));
	}
	...
	public void select_the_radio_buttons() throws Exception {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='pn_cd'])[1]"))).clear();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='pn_cd'])[1]"))).sendKeys("767676");
...
//		driver.findElement(By.id("update_submit")).click();
	...
	public void from_popup_select_the_pickup_location() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//h6[text()='Clinic'])[1]"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	...
	public void select_the_location_and_choose_address() {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@class='provider-addresses'])[1]"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	}
	...
	public void from_popup_select_the_drop_location() {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//h6[text()='Home'])[2]"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	...
	public void select_the_location_and_choose_address_for_drop_location() throws InterruptedException {
		// selecting the home
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@class='provider-addresses'])[2]"))).click();
		Thread.sleep(1000);
	}
	...
	public void select_the_date_and_time_for_appointment() throws Exception {
		// date-time-selection
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input#appointment_tracking_apmnt_date"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("td.is-today"))).click();
		Thread.sleep(1000);
		// slot-time
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input#appointment_tracking_slot_time"))).click();
		Thread.sleep(1000);
		// clicking on the ok
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@class='confirmation-btns'])[2]/button[text()='Ok']"))).click();
		Thread.sleep(2000);
	}
	...
	public void enter_the_price_and_click_on_submit_button() throws Exception {
		// entering the price
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input#appointment_tracking_order_value"))).sendKeys("1000");
		Thread.sleep(2000);
		try {
			// submit
...
//		Thread.sleep(2000);
	...
	public void select_the_paymentmethodthree_and_enter_partial_amount() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//label[text()='Other'])[1]"))).click();
		Robot robot = new Robot();
		robot.keyPress(KeyEvent.VK_PAGE_DOWN);
		Thread.sleep(1000);
...
//		Thread.sleep(2000);
	...
	public void clicking_on_the_viewbutton_and_closingpopup_for_ambulancebooking() throws Exception {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[text()='View'])[1]"))).click();
		Thread.sleep(5000);
		Robot robot = new Robot();
		Thread.sleep(1000);
		robot.keyPress(KeyEvent.VK_CONTROL);
...
//		driver.findElement(By.cssSelector("div#modalApmntShow>div>div>span:nth-of-type(1)")).click();
	...
	public void selecting_Servicewise_Datewise_Itemwise_Summary_and_downloading_the_invoice() throws Exception {
		...
		Thread.sleep(2000);
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[@data-tooltip='Generate Invoice Id'])[1]"))).click();
		Thread.sleep(2000);
...
//		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[text()='Itemwise'])[1]"))).click();
		// OP -Invoice itemwise wise pdf
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a.tooltipped.date_wise_pdf>img"))).click();

		// selecting itemwise and download inovice
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[@class='selection'])[2]"))).click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[text()='Servicewise'])[1]"))).click();
	}
	...
	public void download_the_invoice_receipt_totaladvance_printpdf1() throws Exception {
		...
		// receipt download
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		WebElement receipt1 = wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//div[@class='price-details'])[2]/div[2]/div[2]/a[1]")));
		JavascriptExecutor rpt1 = (JavascriptExecutor) driver;
		rpt1.executeScript("arguments[0].scrollIntoView(true)", receipt1);

		WebElement receipt2 = wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//div[@class='price-details'])[2]/div[3]/div[2]/a[1]")));
		JavascriptExecutor rpt2 = (JavascriptExecutor) driver;
		rpt2.executeScript("arguments[0].scrollIntoView(true)", receipt2);

		WebElement receipt3 = wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//div[@class='price-details'])[2]/div[4]/div[2]/a[1]")));
	...
	public void enter_phone_and_click_on_submit_button_for_shareinvoice1() throws Exception {
		...
		WebElement phone = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("emails")));
		phone.clear();
		phone.sendKeys("sunil.kommayella@nanohealth.in");
		// submit
		wait.until(ExpectedConditions
	...
	public void user_click_on_patientsname_from_ambulance_proformainvoicepage() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[text()='Cucum Oppatient'])[1]"))).click();
	}
	...
	public void user_click_on_bookhomecareservice_from_book_appointment() throws Exception {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//a[@data-tooltip='Book Home Care Service'])/img[1]"))).click();
	}
...
//		Thread.sleep(2000);
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@id='invoiceUpdatesList'])[1]/div[1]/div[1]/span[1]/i[1]"))).click();
		Thread.sleep(3000);
		Robot robot = new Robot();
		robot.keyPress(KeyEvent.VK_PAGE_DOWN);
		Thread.sleep(1000);
	...
	public void select_pay_later_option_from_the_payments() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//label[text()='Pay Later'])[1]"))).click();
	}
	...
	public void click_on_the_invoice_id_to_generate_the_invoice_id() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@data-tooltip='Generate Invoice Id'])[2]")))
				.click();
		Thread.sleep(5000); // requested delay for generation
		Robot robot2 = new Robot();
		robot2.keyPress(KeyEvent.VK_PAGE_DOWN);
		Thread.sleep(1000);
	}
	...
	public void click_on_shareinvoice2_button() throws Exception {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.cssSelector("a.btn.green.right.btn-loader2.service_wise_pdf"))).click();
		Thread.sleep(3000); // requested delay for sharing
	}
	...
	public void enter_mail_and_click_on_submit_button_for_shareinvoice2() throws Exception {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//input[@class='btn green right btn-loader submitBtn'])[1]"))).click();
		Thread.sleep(10000); // keeping large wait for post submission
	}
	...
	public void user_click_on_patientsname_from_homecareservices_proformainvoicepage() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#frst_nm")))
				.sendKeys("Cucumoppatient");
		Thread.sleep(3000);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("div.col.s7.btn-loader.opt_search"))).click();
		Thread.sleep(2000);
	}
	...
	public void select_lab_from_the_dropdown() throws Exception {
		...
		Thread.sleep(10000); // loading tests list
	}
	...
	public void click_on_checkout_button_from_diagnostic_service_page() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a.btn-loader.btn.checkout.btn-block")))
				.click();
		Thread.sleep(2000); // requested delay for checkout
	}
	...
	public void select_the_slot_for_diagnostic_appointment() throws Exception {
		...
		Thread.sleep(2000); // wait after selecting AM slot
		...
		Thread.sleep(2000); // wait after selecting PM slot
	}
	...
	public void select_the_notify_patient_checkboxes_for_diagnostic_booking() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//label[text()='Email'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//label[text()='SMS'])[1]"))).click();
		Thread.sleep(1000);
	}
	...
	public void give_the_hundered_percent_discount_and_apply() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#promo_disc"))).sendKeys("100");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("span#applyCouponModal"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("textarea#comments")))
				.sendKeys("applied 100% discount");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input#applyCouponBtn"))).click();
		Thread.sleep(3000);
		Robot robot = new Robot();
		robot.keyPress(KeyEvent.VK_PAGE_DOWN);
		Thread.sleep(1000);
	...
	public void download_the_invoice_receipt_totaladvance_printpdf3() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a.tooltipped.service_wise_pdf>img")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@class='row summary'])[1]/div[2]/a")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//a[@class='right tooltipped service_wise_pdf'])[1]/img[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//div[@id='modalApmntShow'])[1]/div[1]/div[1]/span[1]/i[1]"))).click();
		Thread.sleep(5000); // requested long wait
	...
	public void user_click_on_patientsname_from_diagnostic_proformainvoicepage() throws Exception {
		...
		try {
			WebElement span = wait.until(ExpectedConditions
					.presenceOfElementLocated(By.xpath("(//div[@id='invoice_modal'])[1]/div[1]/div[1]/span[1]/i[1]")));
			if (span.isDisplayed()) {
				span.click();
				Thread.sleep(3000);
			}
	...
	public void user_click_on_bookdietitianappointment_from_book_appointment() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		Actions diet = new Actions(driver);
		diet.moveToElement(driver.findElement(By.xpath("(//a[@data-tooltip='Book Dietitian Appointment'])[1]/img[1]")))
				.build().perform();
		Thread.sleep(1000);
		wait.until(ExpectedConditions
	...
	public void select_the_type_and_slot_for_dietitan_appointment() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@id='saved-addresses'])[2]/div[1]")))
				.click();
		Thread.sleep(2000); // waiting for slot loading
		JavascriptExecutor js11 = (JavascriptExecutor) driver;
		boolean selected = false;
		List<WebElement> am = driver.findElements(By.xpath("//span[contains(text(),'AM')]"));
	...
	public void select_the_paymentmethods4() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@data-tooltip='Insurer'])[1]/img[1]")))
				.click();
		Thread.sleep(2000); // waiting for modal

		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//label[text()='Insurance'])[2]"))).click();
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("(//input[@id='insurance_policy_detail_id_card'])[1]")))
				.sendKeys("1234567");
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("(//input[@id='insurance_policy_detail_policy_no'])[1]")))
				.sendKeys("17892922");
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//input[@id='insurance_policy_detail_policy_start_date'])[1]")))
				.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//td[@class='is-today'])[1]/button[1]"))).click();
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//label[text()='Insurance Company'])[1]/following-sibling::span[1]")))
				.click();
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//li[contains(text(),'Insurance Company Limited')])"))).click();

		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//input[@class='btn right green ins_submit btn-loader'])[1]")))
				.click();
		Thread.sleep(5000); // submission delay
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[text()='Select'])[1]"))).click();

		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[text()='Pre-authorization Response'])[1]")))
				.click();
		wait.until(ExpectedConditions.elementToBeClickable(
		...
		Thread.sleep(1000);
//		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//td[@class='is-today'])[1]/button[1]"))).click();
		Thread.sleep(1000);
//		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
		...
		action1.sendKeys("500").perform();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='update_submit'])[1]"))).click();
		Thread.sleep(5000);
		// clicking on the claim approval response button
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[text()='Claim Approval Response'])[1]"))).click();
		Thread.sleep(3000);
	...
	public void click_on_shareinvoice4_button() throws Exception {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.cssSelector("a.btn.green.right.btn-loader2.service_wise_pdf"))).click();
		Thread.sleep(5000); // requested delay for sharing
	}
	...
	public void enter_mail_and_click_on_submit_button_for_shareinvoice4() throws Exception {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//input[@class='btn green right btn-loader submitBtn'])[1]"))).click();
		Thread.sleep(10000); // long submission wait
	}
	...
	public void user_click_on_bookopprocedures_from_book_appointment() throws Exception {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//a[@data-tooltip='Book Minor Procedures'])[1]/img[1]"))).click();
	}
	...
	public void user_click_on_submit_button() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input#continue-ot"))).click();
	}
	...
	public void from_team_popup_select_the_therapist_leaddoctor_supportingdoctor_counsellor() throws Exception {
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[contains(text(),'Sunil')])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input#op_patient_detail_referred_by")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[contains(text(),'Dr. Doctor One')])[1]")))
				.click();
		Thread.sleep(1000);
	}
	...
	public void click_on_continue_button_from_team() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='continue-team'])[1]"))).click();
		Thread.sleep(2000);
	}
	...
	public void enter_the_nursing_and_additional_charges() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("(//input[@id='op_patient_detail_nursing_chrge'])[1]")))
				.sendKeys("1");
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='additional_charges'])[1]")))
				.sendKeys("1");
	}
	...
	public void proformainvoice_page_will_be_opened_for_opprocedure() throws Exception {
		...
		Thread.sleep(1000);
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='promo_amnt'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Proceed'])[1]"))).click();
		Thread.sleep(1000);

		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='promo_amnt'])[1]")))
				.sendKeys("60");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[@id='applyCouponModal'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//textarea[@id='comments'])[1]")))
				.sendKeys("Paid partial amount using amount discount");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='applyCouponBtn'])[1]"))).click();
		Thread.sleep(2000);
		Robot robot = new Robot();
		robot.keyPress(KeyEvent.VK_PAGE_DOWN);
		Thread.sleep(1000);
		...
		js.executeScript("window.scrollBy(0, 400)");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@name='promo_amnt'])[1]"))).click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Proceed'])[1]"))).click();
...
//		}
		...
		// mouse hover on the patientname
		Actions patient = new Actions(driver);
		patient.moveToElement(driver.findElement(By.xpath("(//a[text()='Cucum Oppatient'])[2]"))).build().perform();
		Thread.sleep(2000);
		// mouse hover on the book new appointment
		Actions book = new Actions(driver);
		book.moveToElement(driver.findElement(By.xpath("(//a[@data-tooltip='Book New Appointment'])[1]/img[1]")))
				.build().perform();
		Thread.sleep(1000);
...
//		Thread.sleep(2000);
	...
	public void applying_discount_for_five_percentage_and_entering_the_comments() throws Exception {
		// adding 10% discount
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input#promo_disc"))).sendKeys("10");
		Thread.sleep(2000);
		// adding comment for the discount
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("span#applyCouponModal"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("textarea#comments")))
				.sendKeys("10% discount for the doctor appointment");
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input#applyCouponBtn"))).click();
		Thread.sleep(2000);
	}
	...
	public void paying_the_remaining_balance_and_entering_the_comments() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		// entering the cash
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input#advance_field"))).sendKeys("1440");
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("i#paymentComment"))).click();
		Thread.sleep(2000);
		/*
...
//		driver.manage().timeouts().implicitlyW	
	...
	public void download_the_invoice_receipt_totaladvance_printpdf8() throws Exception {
		...
		Actions receipt = new Actions(driver);
		WebElement totalReceipt = wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//a[@data-tooltip='Total Receipt'])[1]/img[1]")));
		receipt.moveToElement(totalReceipt).build().perform();
		Thread.sleep(1000);
		totalReceipt.click();
		Thread.sleep(2000);
	}
	...
	public void click_on_the_confirmed_status_for_doctor_in_the_appointments() throws Exception {
		...
		action.moveToElement(
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-apmnts'])[1]")))).click()
				.build().perform();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-doc-consultations'])[1]")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.cssSelector("a.btn-loader.status_links.cnfrd_btn.tooltipped"))).click();
		Thread.sleep(3000);
	}
	...
	public void click_on_the_first_patients_appointment_id() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//tr[@class='consultRow odd'])[1]/td[2]/a")))
				.click();
		Thread.sleep(3000);
	}
	...
	public void click_on_the_cancel_button_from_the_popup() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[text()='Cancel'])[3]"))).click();
		Thread.sleep(1000);
	}
	...
	public void from_cancel_appointment_popup_enter_the_cancellation_reason() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("comments"))).sendKeys("test reason");
		Thread.sleep(1000);
	}
	...
	public void click_on_the_refund_button_from_cancel_appointment_popup() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[text()='Refund'])[1]"))).click();
		Thread.sleep(2000);
	...
	public void enter_the_refund_reason_and_click_on_ok() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("textarea#refund_rsn")))
				.sendKeys("refund reason");
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a.modal-close.btn.green.right.refundOk")))
				.click();
	}
	...
	public void patientprofile_will_opened_after_refund_proformainvoicepage() throws Exception {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		WebElement bookDialysis = wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//a[@data-tooltip='Book Dialysis'])[1]/img[1]")));
		dialysis.moveToElement(bookDialysis).build().perform();
		Thread.sleep(1000);
		bookDialysis.click();
		Thread.sleep(2000);
	}
	...
	public void patient_profile_is_opened_click_on_the_book_dialysis() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(
				ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='op_patient_detail_admission_dt'])[1]")))
				.click();
		wait.until(ExpectedConditions
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//li/span[text()='" + currentMonth + "']")))
				.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//td[@class='is-today'])[1]/button[1]"))).click();
		Thread.sleep(2000);
	}
	...
	public void select_the_procedure_date_and_start_end_time() throws Exception {
		...
		Thread.sleep(1000);
		// 11pm
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='timepicker-dial timepicker-hours'])[1]/div[11]"))).click();
		Thread.sleep(1000);
		// 00
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='timepicker-dial timepicker-minutes'])[1]/div[1]"))).click();
		Thread.sleep(1000);
		// pm
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='timepicker-span-am-pm'])[1]/div[2]"))).click();
		Thread.sleep(1000);
		// ok
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='timepicker-footer'])[1]/div[1]/button[2]"))).click();
		Thread.sleep(1000);
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='timepicker-dial timepicker-hours'])[1]/div[11]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='timepicker-dial timepicker-minutes'])[2]/div[12]"))).click();
		Thread.sleep(1000);
		// pm
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='timepicker-span-am-pm'])[2]/div[2]"))).click();
		Thread.sleep(1000);
		// ok
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='timepicker-footer'])[2]/div[1]/button[2]"))).click();
		Thread.sleep(1000);
	...
	public void click_on_the_continue_button_from_the_dates_popup() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='continue-ot'])[1]"))).click();
		Thread.sleep(2000);
	}
	...
	public void select_the_lead_doctor_and_click_on_the_continue_button() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[contains(text(),'Dr. Doctor')])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='continue-team'])[1]"))).click();
		Thread.sleep(3000);
	}
	...
	public void click_on_the_submit_button_from_invoice_popup() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='btn-loader'])[1]"))).click();
		Thread.sleep(3000);
		Robot pgdwn = new Robot();
	...
	public void enter_the_amount_and_generate_the_invoice_id_for_the_invoice() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='advance_field'])[1]"))).sendKeys("100");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		// clicking on the comment
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("i#paymentComment"))).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		// comment
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("textarea#payment_cmnt")))
				.sendKeys("receipt comment for 100 rupees for payment method cash");
		Thread.sleep(1000);
		// ok
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a.modal-close.btn.green.right.payCmntOk"))).click();
		Thread.sleep(1000);
		// submit
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector("button#bookNowBtn")))).click();
		Thread.sleep(3000);
	...
	public void download_the_invoice_receipt_and_share_invoice_to_the_mail() throws Exception {
		...
		taxinv.moveToElement(driver.findElement(By.xpath("(//a[@data-tooltip='Convert to tax invoice'])[1]/img[1]")))
				.build().perform();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[@data-tooltip='Convert to tax invoice'])[1]/img[1]"))).click();
		Thread.sleep(4000);
		// download invoice
		Actions inv = new Actions(driver);
		inv.moveToElement(driver.findElement(By.xpath("(//a[@data-tooltip='Print Invoice'])[1]/img[1]"))).build()
				.perform();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[@data-tooltip='Print Invoice'])[1]/img[1]"))).click();
		Thread.sleep(5000);
		Robot pgdwn = new Robot();
		pgdwn.keyPress(KeyEvent.VK_PAGE_DOWN);
		Thread.sleep(2000);
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[@data-tooltip='Total Receipt'])[1]/img[1]"))).click();
		Thread.sleep(2000);
		// print
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a.btn.green.right.tooltipped.service_wise_pdf"))).click();
		Thread.sleep(4000);
		// print without details
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a.btn.btn_blue.right.tooltipped.service_wise_pdf"))).click();
		Thread.sleep(4000);
		// share invoice
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a.btn.green.right.btn-loader2.service_wise_pdf"))).click();
		Thread.sleep(3000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("emails"))).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("phone"))).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("emails"))).sendKeys("sunil.kommayella@nanohealth.in");
		Thread.sleep(1000);
		// submit
		...
		Thread.sleep(10000);
		// clicking on the patient name
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[text()='Cucum Oppatient'])[1]"))).click();
		Thread.sleep(3000);
		// close for pending amount
...
//		driver.findElement(By.cssSelector("div.bkng_services_prfl>div>a:nth-of-type(15)>img")).click();
	...
	public void select_the_programa_and_remove_one_of_the_program() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//i[text()='remove'])[4]"))).click();
		Thread.sleep(2000);
	}
...
//		driver.findElement(By.cssSelector("a.waves-effect.btn.checkout.btn-block")).click();
	...
	public void select_addreferredby_and_select_the_program_start_date() throws Exception {
		// referred by
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//label[text()='Referred By'])[1]/following-sibling::span[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//li[contains(text(),'Dr. Doctor')])[1]"))).click();
		Thread.sleep(2000);

		// start date
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@class='pick-date stdt'])[1]"))).click();
		Thread.sleep(1000);
		// Click on Year dropdown
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='select-wrapper select-year'])[1]/input[1]"))).click();
		Thread.sleep(1000);
		LocalDate today = LocalDate.now();
		String currentYear = String.valueOf(today.getYear());
		Thread.sleep(1000);
		// Select current year dynamically
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li/span[text()='" + currentYear + "']"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='select-wrapper select-month'])[1]/input[1]"))).click();
		Thread.sleep(1000);
		LocalDate today1 = LocalDate.now();
		String currentMonth = today1.getMonth().getDisplayName(TextStyle.FULL, Locale.ENGLISH);
		Thread.sleep(1000);
		// Select current month dynamically
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li/span[text()='" + currentMonth + "']"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//td[@class='is-today'])[1]/button[1]"))).click();
		// driver.findElement(By.xpath("//button[text()='21']")).click();
		Thread.sleep(3000);
		// click on the activity list
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//img[@data-tooltip='View activity list'])[1]"))).click();
		Thread.sleep(3000);
		// clicking on the back button
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[text()='Back'])[2]"))).click();
		Thread.sleep(3000);
...
//		Thread.sleep(2000);
	...
	public void click_on_the_submit_button_from_select_invoice_of_addprogram_booking() throws Exception {
		// submit
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#btn-loader"))).click();
		Thread.sleep(2000);
		Robot robot1 = new Robot();
		robot1.keyPress(KeyEvent.VK_PAGE_DOWN);
		Thread.sleep(2000);
	...
	public void click_on_receipt_comment_and_enter_comment_for_program_appointment() throws Exception {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		// comment
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("textarea#payment_cmnt"))).sendKeys("test receipt comment");
		Thread.sleep(1000);
		// submit
...
//		driver.findElement(By.cssSelector("button#bookNowBtn")).click();
	...
	public void enter_mail_and_click_on_submit_button_for_shareinvoice10() throws Exception {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//input[@class='btn green right btn-loader submitBtn'])[1]"))).click();
		Thread.sleep(10000); // Wait for sharing to complete

		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[@class='col s3 patient_card ip_card'])[1]")))
				.click();
		...
		Actions action = new Actions(driver);
		WebElement bookPharmacy = wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//a[@data-tooltip='Book Pharmacy Order'])[1]/img[1]")));
		action.moveToElement(bookPharmacy).build().perform();
		Thread.sleep(1000);
		bookPharmacy.click();
		...
		WebElement brandInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
		...
		// deliver
		WebElement deliverButton = wait
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//input[@value='Delivery'])[1]")));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//label[text()='Cash']"))).click();
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#advance_field"))).sendKeys("50");
		...
		// printing
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//a[@class='tooltipped service_wise_pdf'])[1]/img[1]"))).click();
		Robot robot2 = new Robot();
		robot2.keyPress(KeyEvent.VK_PAGE_DOWN);
		Thread.sleep(1000);
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//input[@class='btn green right btn-loader submitBtn'])[1]"))).click();
		Thread.sleep(10000); // Wait for submission confirmation
	...
	public void create_a_dynamic_op_package() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@data-tooltip='Add Program'])[1]/img[1]")))
				.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@data-tooltip='Add New Program'])[1]/i[1]")))
				.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[text()='NanoHealth_OPD'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input#pckg_nm")))
				.sendKeys("Cucum testpackage");
		Thread.sleep(1000);
		WebElement duration = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='duration'])[1]")));
		duration.clear();
		Thread.sleep(1000);
		duration.sendKeys("31");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@data-tooltip='Sync Data'])[1]/i[1]")))
				.click();
		Thread.sleep(2000);
		...
		alert.accept();
		Thread.sleep(2000);
		WebElement invoiceSearch = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='invoice_search'])[1]")));
		invoiceSearch.sendKeys("Diagnostic");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[text()='Diagnostics'])[1]"))).click();
		Thread.sleep(1000);
		invoiceSearch.sendKeys("Diagnostic");
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[text()='Diagnostics'])[2]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//label[text()='Repeat'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//label[text()='Frequency'])[1]/following-sibling::select[1]/following-sibling::span[1]")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[text()='Weekly'])[1]"))).click();
		Thread.sleep(1000);
		WebElement repeatCount = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='repeat_count'])[1]")));
		repeatCount.clear();
		repeatCount.sendKeys("3");
		Thread.sleep(1000);
		WebElement weekDayDropdown = wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//label[text()='WeekDay'])[1]/following-sibling::select[1]/following-sibling::span[1]")));
		weekDayDropdown.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[contains(text(),'Monday')])[1]"))).click();
		Thread.sleep(1000);
		weekDayDropdown.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[contains(text(),'Wednesday')])[1]")))
				.click();
		Thread.sleep(1000);
		weekDayDropdown.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[contains(text(),'Friday')])[1]"))).click();
		Thread.sleep(1000);
		weekDayDropdown.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[contains(text(),'Sunday')])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//span[@class='select2-selection__choice__remove'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='repeat_count'])[1]"))).click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//i[@class='fa fa-times-circle'])[2]"))).click();
		Thread.sleep(1000);
		Actions action1 = new Actions(driver);
		WebElement infoCircle = wait
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//i[@class='fa fa-info-circle'])[1]")));
		action1.moveToElement(infoCircle).build().perform();
		Thread.sleep(1000);
		invoiceSearch.sendKeys("Doctor");
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[contains(text(),'Doctor')])[1]"))).click();
		Thread.sleep(1000);
		invoiceSearch.sendKeys("Minor");
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[contains(text(),'Minor')])[1]"))).click();
		Thread.sleep(1000);
		WebElement pkgPrice = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='pkg_price'])[1]")));
		pkgPrice.clear();
		Thread.sleep(1000);
		pkgPrice.sendKeys("1000");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Submit'])[1]"))).click();
		Thread.sleep(2000);
		Robot robot3 = new Robot();
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='advance_field'])[1]")))
				.sendKeys("1000");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button#bookNowBtn"))).click();
		Thread.sleep(1000);
		Actions id = new Actions(driver);
		WebElement generateInvoiceId = wait.until(
				ExpectedConditions.presenceOfElementLocated(By.xpath("(//a[@data-tooltip='Generate Invoice Id'])[1]")));
		id.moveToElement(generateInvoiceId).build().perform();
		Thread.sleep(1000);
		generateInvoiceId.click();
		Thread.sleep(1000);
		Actions taxinv = new Actions(driver);
		WebElement convertTax = wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//a[@data-tooltip='Convert to tax invoice'])[1]/img[1]")));
		taxinv.moveToElement(convertTax).build().perform();
		Thread.sleep(1000);
		convertTax.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a.tooltipped.service_wise_pdf>img")))
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@class='btn-loader profile_nav'])[1]")))
				.click();
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[contains(text(),'Programs')])[2]"))).click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[text()='Cucum testpackage'])[1]"))).click();

		String parentWindow = driver.getWindowHandle();
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//td[contains(normalize-space(),'Dr. Doctor one')])[1]/following-sibling::td[5]/a[1]")))
				.click();
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button#bookNowBtn"))).click();
		Thread.sleep(5000); // Process booking
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//a[@class='btn-loader show_apmnts show-highlight'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//div[@id='modalApmntShow'])[1]/div[1]/div[1]/span[1]/i[1]"))).click();
		Thread.sleep(1000);
	...
	public void merge_the_invoices_from_the_history() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//ul[@class='tabs'])[1]/li[2]/a[1]"))).click();
		Thread.sleep(1000);
		wait.until(
				ExpectedConditions.elementToBeClickable(By.xpath("(//a[@data-tooltip='More Appointments'])[1]/i[1]")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='ptnt_history'])[1]"))).click();
		Thread.sleep(1000);
		// clicking on the invoice
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='clinic_patient_inv_hstry'])[2]")))
				.click();
		Thread.sleep(1000);
		// close for pending amount
		try {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@data-tooltip='Merge Invoice'])[1]/img[1]")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//form[@id='merge_invoices'])[1]/div[1]/div[1]/div[1]/div[1]/label[1]"))).click();
		Thread.sleep(1000);
		// submit
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='saveDateInvoice'])[1]"))).click();
		Thread.sleep(3000);
		// clicking on the invoice op number
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//div[@class='invoice_container op_nmbr'])[1]/a[1]"))).click();
		Thread.sleep(1000);
...
//		// clicking on the appointment id
		...
		Thread.sleep(1000);
		// closing popup
//		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@id='schdlApmntsModal'])[1]/div[1]/div[1]/span[1]/i[1]"))).click();
//		
//		// clicking on the invoice op number
//		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[contains(text(),'OP-')])[2]"))).click();

...
//		driver.manage().window().maximize();
	...
	public void enter_test_mailid_and_pswd(String mailid, String pswd) throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("user_login"))).sendKeys(mailid);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("user_password"))).sendKeys(pswd);
		Thread.sleep(5000);
	}
...
//		Thread.sleep(1000); 
	...
	public void change_role_to_cdpadmin_and_delete_existing_patients() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("frst_nm"))).sendKeys("8887779991");
	...
	public void click_on_the_reports_and_select_corporates() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-reports'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='corprate-list'])[1]"))).click();
		Thread.sleep(3000);
	}
...
//		Thread.sleep(1000);
	...
	public void add_familymember_for_the_employee_in_the_corporate() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[@class='selection'])[3]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[contains(text(),'Ms./Mrs.')])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='first_name'])[1]")))
				.sendKeys("Corporate");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		...
		Thread.sleep(1000);
		// age
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='age'])[1]"))).sendKeys("21");
		Thread.sleep(1000);
		// nmbr
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='nmbr'])[1]")))
				.sendKeys("8887779992");
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[contains(text(),'Sister')])[1]"))).click();
		Thread.sleep(1000);
		// submit
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Submit'])[2]"))).click();
		Thread.sleep(3000);
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//table[@id='example'])[1]/tbody[1]/tr[1]/td[6]/a[1]"))).click();
		Thread.sleep(2000);
		// closing the popup
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//div[@id='patientHistoryModal'])[1]/div[1]/div[1]/span[1]/i[1]")))
				.click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//p[contains(text(),'More')])[1]"))).click();
		Thread.sleep(2000);
	...
	public void convert_employee_to_patient_by_filling_registration_form() throws Exception {
		...
		wait.until(
				...
				.click();
		Thread.sleep(5000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='address-line1'])[1]"))).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='address-line1'])[1]")))
				.sendKeys("Corporate");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));

		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='autocomplete-input'])[1]"))).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='autocomplete-input'])[1]")))
				.sendKeys("Test");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));

		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='landmark'])[1]"))).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='landmark'])[1]"))).sendKeys("Test");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));

		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='pn_cd'])[1]"))).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='pn_cd'])[1]"))).sendKeys("090909");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		Thread.sleep(1000);
		// demand program
	...
	public void click_on_the_reports_and_select_formsreport() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-reports'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='forms_report'])[1]"))).click();
		Thread.sleep(3000);
	}
...
//		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[text()='Registrarion'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[text()='Last 7 days'])[1]"))).click();
		Thread.sleep(1000);
//		// from-date
...
//		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//table[@id='forms-report-table'])[1]/tbody[1]/tr[1]/td[4]/a[1]")).click();
		Thread.sleep(3000);
		// clicking on the download button
		driver.findElement(By.xpath("(//i[text()='file_download'])[2]")).click();
		Thread.sleep(2000);
		// closing the popup
...
////				Thread.sleep(2000);
	...
	public void click_on_the_reports_and_select_the_recommendations() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-reports'])[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-recommendations'])[1]"))).click();
		Thread.sleep(5000);
	...
	public void add_next_engagement_for_the_patient() throws Exception {
		...
		nextengicon.moveToElement(driver.findElement(By.xpath("(//a[@data-tooltip='Patient Engagement'])[1]/img[1]")))
				.build().perform();
		Thread.sleep(2000);
		nextengicon.moveToElement(driver.findElement(By.xpath("(//a[@data-tooltip='Patient Engagement'])[1]/img[1]")))
				.click().build().perform();
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//label[text()='Recommendation Status'])[2]/following-sibling::span[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[text()='Pending'])[2]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//textarea[@id='patient_engagement_detail_notes'])[1]")))
				.sendKeys("Testing description");
		Thread.sleep(1000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//input[@id='patient_engagement_detail_prfrd_followup_date'])[1]")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[@class='month-next'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[text()='1'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//input[@id='patient_engagement_detail_prfrd_followup_time'])[1]")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(
		...
		Thread.sleep(2000);
		// submit
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='engmtSubmitBtn'])[1]"))).click();
		Thread.sleep(5000);
		// closing popup
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//div[@id='patient-engagement-modal'])[1]/div[1]/div[1]/span[1]/i[1]"))).click();
		Thread.sleep(3000);
		driver.navigate().refresh();
		Thread.sleep(2000);
		...
		checkbox.click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Update Care Team'])[1]")))
				.click();
		Thread.sleep(3000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[@class='selection'])[9]"))).click();
		Thread.sleep(1000);
...
//		Thread.sleep(1000);
		...
		// closing popup
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//div[@id='identification-modal'])[1]/div[1]/div[1]/span[1]/i[1]")))
				.click();
		Thread.sleep(3000);
	}
	...
	public void click_on_the_reports_and_select_the_patients() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-reports'])[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-list-patients'])[1]"))).click();
		Thread.sleep(8000);
	...
	public void click_on_the_group_button_and_delete_the_existing_group() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='q_group_name_cont'])[1]")))
				.sendKeys("Cucum");
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Search'])[1]"))).click();
		Thread.sleep(3000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//i[@class='fa fa-trash-o'])[1]"))).click();
		Thread.sleep(2000);
	...
	public void create_a_new_group_and_add_some_of_the_patients_to_the_created_group() throws Exception {
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='group_master_group_name'])[1]")))
				.sendKeys("Cucum group");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//textarea[@id='group_master_desc'])[1]")))
				.sendKeys("Cucum group");
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Save'])[1]"))).click();
		Thread.sleep(2000);
	...
	public void send_info_to_the_patients_using_send_info_button_from_groups() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[text()='Patients'])[3]"))).click();
		Thread.sleep(10000);
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Add To Group'])[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Cucum group'])[1]"))).click();
		Thread.sleep(10000);
		// clicking on the groups
		WebElement element = driver.findElement(By.xpath("/html/body/main/div[1]/div[2]/div/div/div/ul/li[2]/a"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		...
		Thread.sleep(3000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//table[@id='example'])[1]/tbody[1]/tr[1]/td[1]/label[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Send Info'])[1]"))).click();
		Thread.sleep(3000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='notification_title'])[1]")))
				.sendKeys("Testing title");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//textarea[@id='textarea1'])[1]")))
	...
	public void click_on_the_reports_and_select_referrals() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-reports'])[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-referrals'])[1]"))).click();
		Thread.sleep(3000);
	}
	...
	public void search_with_patient_name_or_dates_and_download_the_data() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//label[text()='Hospital Name'])[1]/following-sibling::span[1]")))
				.click();
		Thread.sleep(1000);
		...
		Thread.sleep(3000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//label[text()='Referral type'])[1]/following-sibling::span[1]")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[text()='Self'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//label[text()='Referred by'])[1]/following-sibling::span[1]")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[text()='Self'])[2]"))).click();
		Thread.sleep(1000);
		// search
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@value='Search'])[1]"))).click();
		Thread.sleep(3000);
		...
		if (driver.findElement(By.xpath("//*[@id=\"invoice_modal\"]/div/div[1]/span/i")).isDisplayed()) {
			...
			System.out.println("No pending amount for the patient");
		}
	}
	...
	public void click_on_the_reports_and_select_consultations() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-reports'])[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='videoCall'])[1]"))).click();
		Thread.sleep(5000);
	}
	...
	public void search_with_patient_name_or_dates_and_download_consultations_data() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//label[text()='Doctor'])[1]/preceding-sibling::span[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[contains(text(),'Dr. Doctor')])[1]")))
				.click();
		Thread.sleep(1000);
//		wait.until(ExpectedConditions
//				.elementToBeClickable(By.xpath("(//label[text()='Consulted type'])[1]/preceding-sibling::span[1]")))
//				.click();
//		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[text()='Video'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='from-date'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[text()='1'])[1]"))).click();
	...
	public void click_on_the_programutilization_button_and_search_with_name_and_dates_fileds() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-reports'])[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-pckgUtilisation'])[1]"))).click();
		Thread.sleep(3000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//label[text()='Packagename'])[1]/following-sibling::span[1]")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//li[contains(text(),'Test')])[1]"))).click();
		Thread.sleep(1000);
		// from-date
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='q_schedule_date_time_gteq'])[1]")))
				.click();
		Thread.sleep(1000);
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[text()='1'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='q_schedule_date_time_lteq'])[1]")))
				.click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//td[@class='is-today'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//label[text()='Status'])[1]/following-sibling::span[1]"))).click();
		Thread.sleep(1000);
	...
	public void click_on_reports_and_select_carts_and_search_with_dates() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-reports'])[1]"))).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@id='admin-carts'])[1]"))).click();
		Thread.sleep(3000);
//		driver.findElement(By.xpath("(//input[@id='q_patient_master_frst_nm_or_patient_master_lst_nm_cont'])[1]"))
//				.sendKeys("Test");
//		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='q_created_at_gteq'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[@class='month-prev'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[text()='1'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='q_created_at_lteq'])[1]"))).click();
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//td[@class='is-today'])[1]"))).click();
		Thread.sleep(2000);
		// search
...
//			cash.click();
			...
			Thread.sleep(1000);
			wait.until(
					ExpectedConditions.elementToBeClickable(By.xpath("a.btn.green.right.btn-loader2.service_wise_pdf")))
					.click();
			Thread.sleep(2000);
			...
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
			wait.until(ExpectedConditions.elementToBeClickable(By.id("phone"))).sendKeys("8790098500");
			Thread.sleep(1000);
			// submit
...
//			cash.click();
			...
			wait.until(ExpectedConditions.elementToBeClickable(By.id("phone"))).clear();
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
			wait.until(ExpectedConditions.elementToBeClickable(By.id("emails")))

...
//		driver.manage().window().maximize();
	...
	public void enter_email8_password8(String email8, String password8) throws Exception {
		...
		driver.findElement(By.id("user_login")).sendKeys(email8);
	...
	public void select_the_cdp_and_role_cdpadmin_to_delete_the_existing_patient() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.id("frst_nm")).sendKeys("6656767688");
		Thread.sleep(3000);
...
//		fee.click();
	...
	@Then("open the patientprofile and fill up the preauthorizationform with editable picture and save")
	public void open_the_patientprofile_and_fill_up_the_preauthorizationform_with_editable_picture_and_save()
			throws Exception {
		driver.findElement(By.xpath("(//a[contains(text(),'Cucum Prescription')])[1]")).click();
		Thread.sleep(5000);
		Actions form = new Actions(driver);
		form.moveToElement(driver.findElement(By.xpath("(//a[@data-tooltip='Forms'])[1]/img[1]"))).build().perform();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[text()='PreAuthorization Form'])[1]")).click();
		Thread.sleep(3000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//textarea[@id='bulletPointTextNew'])[1]")).sendKeys("Test" + Keys.ENTER);
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//textarea[@id='bulletPointTextNew'])[1]")).sendKeys("Test2");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
//		driver.findElement(
//				By.xpath("//li[contains(@class,'active')]//span[normalize-space()='PreAuthorization Form']\r\n" + ""))
//				.click();
//		Thread.sleep(3000);
		// download pdf
		driver.findElement(
				By.xpath("//span[contains(text(),'PreAuthorization Form')]/ancestor::div[@class='row']//img[1]"))
				.click();
		Thread.sleep(5000);
		driver.findElement(
				By.xpath("(//span[normalize-space()='PreAuthorization Form'])[1]/following-sibling::span/a[2]/img[1]"))
				.click();
		Thread.sleep(3000);
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//input[@id='emails'])[1]"))
				.sendKeys("sunil.kommayella@nanohealth.in,kommayellasunil@gmail.com");
		Thread.sleep(2000);
		// submit
...
//		Thread.sleep(2000);
	...
	public void click_on_questionmark_icon_to_create_new_brand_in_prescription() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//img[@class='new_brand_entry_icon'])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//label[text()='Brand Name'])[1]/following-sibling::textarea[1]"))
				.sendKeys("Prescription brand");

		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@class='select-dropdown dropdown-trigger'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li/span[text()='Tablet'])")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//textarea[@class='new_brand_desc'])[1]")).sendKeys("Automation testing brand");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@value='Submit'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//div[text()='0-1-1-1'])[1]")).click();
		Thread.sleep(1000);
...
//		Robot robot = new Robot();
	...
	public void select_procedures_and_enter_comments() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//textarea[@id='textareaField'])[1]")).click();
		Thread.sleep(1000);

Feature: Writing prescription to a patient from doctor role

  Scenario: Booking doctor appointment and writing prescription
    Given navigating to the nh_url "https://customer.nanohealthplan.com/users/sign_in"
    Then enter email8 "sunilk@nh.com" password8 "Chakra@1"

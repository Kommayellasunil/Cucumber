...
//		driver.manage().window().maximize();
	...
	public void enter_email4_password4(String email4, String password4) throws Exception {
		driver.findElement(By.id("user_login")).sendKeys(email4);
		Thread.sleep(1000);
		driver.findElement(By.id("user_password")).sendKeys(password4);
		Thread.sleep(15000);
	}
	...
	public void delete_the_existing_elder_from_the_cdpadmin_role_and_click_on_the_brand_logo_to_change_role()
			throws Exception {
//		// selecting the role as cdpadmin
...
//		Thread.sleep(3000);
	...
	public void selecting_the_profile_for_manager_role() throws Exception {
		...
		driver.findElement(By.xpath("(//div[normalize-space(text())='ClinicManager - Delhi'])[1]")).click();
		Thread.sleep(5000);
	...
	public void enter_the_details_for_the_elder_registration() throws Exception {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(By.xpath("(//input[@id='lst_name'])[1]")).sendKeys("elderflow");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		// entering the age
...
//		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='address-line1'])[1]")).sendKeys("Test1");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//input[@name='adrs_line2'])[1]")).sendKeys("Test2");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//input[@id='landmark'])[1]")).sendKeys("Landmark");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//input[@id='pn_cd'])[1]")).sendKeys("989898");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
...
//		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//div[@id='saved-addresses'])[2]/div[1]/div[2]/div[1]/a[1]/i[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//input[@id='address_detail_area'])[1]")).sendKeys("test area");
		Thread.sleep(2000);
...
//		Thread.sleep(3000);
	...
	public void assing_care_team_from_the_patient_profile_through_care_team_icon() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[contains(text(),'HomeCare')])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//li[contains(text(),'Sunil K (sunilkhc@nh.com)')])[1]")).click();
		Thread.sleep(2000);
		// save
	...
	public void book_the_home_care_attendant_appointment_to_the_registered_elder() throws Exception {
		...
		action.moveToElement(driver.findElement(By.xpath("(//a[@data-tooltip='Book Home Attendant'])[1]/img[1]")))
				.build().perform();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@data-tooltip='Book Home Attendant'])[1]/img[1]")).click();
		Thread.sleep(3000);
		// clicking on the homecare attendant
		driver.findElement(By.xpath("(//h6[text()='Home Attendant'])[1]")).click();
		Thread.sleep(3000);
		// selecting the address
		driver.findElement(By.xpath("(//div[@id='saved-addresses'])[2]")).click();
		Thread.sleep(2000);
		// repeat
		...
		repeat11.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Frequency'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Daily'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='repeat_count'])[1]")).clear();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='repeat_count'])[1]")).sendKeys("10");
		Thread.sleep(1000);
		// start date
		...
		Thread.sleep(1000);
		//
		driver.findElement(By.xpath("(//input[@id='repeat_end_time'])[1]")).click();
		Thread.sleep(2000);
		// 11
		driver.findElement(
	...
	public void change_the_daily_rate_amount_in_the_popup_and_select_paylatet() throws Exception {
		...
		driver.findElement(By.xpath("(//input[@id='sales_price'])[1]")).clear();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='sales_price'])[1]")).sendKeys("500" + Keys.TAB + Keys.TAB);
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//div[@id='due'])[1]")).click();
		Thread.sleep(3000);
	...
	public void pay_the_amount_generate_the_invoice_and_share_donwload_the_inovice() throws Exception {
		...
		Thread.sleep(2000);
		// pay now
		driver.findElement(By.xpath("(//input[@id='advance_field'])[1]")).sendKeys("5000");
		Thread.sleep(2000);
		// submit
		driver.findElement(By.xpath("(//button[@id='bookNowBtn'])[1]")).click();
		Thread.sleep(5000);
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//a[@data-tooltip='Convert to tax invoice'])[1]")).click();
		Thread.sleep(3000);
		// printing
	...
	public void open_patient_profile_and_assign_the_carer_to_the_elder_tasks() throws Exception {
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("(//label[text()='Carer'])[1]/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[contains(text(),'Sunil K (sunilkhc@nh.com)')])[1]")).click();
		Thread.sleep(2000);

		driver.findElement(By.xpath("(//input[@id='activity_cost'])[1]")).sendKeys("0");
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='activity_cost'])[1]")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//input[@id='activity_cost'])[1]")).sendKeys("10000");
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//input[@id='activity_cost'])[1]")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//input[@id='activity_cost'])[1]")).sendKeys("500");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='submit'])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@data-tooltip='Add/Update Tasks'])[1]/img[1]")).click();
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("(//a[@data-tooltip='More Schedules'])[1]")).click();
		Thread.sleep(3000);
	...
	public void click_on_the_checkin_button_and_update_the_checkin_reason() throws Exception {
		driver.findElement(By.xpath("(//a[text()='CheckIn'])[1]")).click();
		Thread.sleep(2000);
		WebElement others = driver.findElement(By.xpath("//label[normalize-space(text())='Others'][1]"));
		others.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//textarea[@id='cmmts'])[1]"))
	...
	public void click_on_the_carerpay_from_billing_and_search_and_approve_the_status() throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@id='carer_report'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//label[text()='Manager'])[1]/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[contains(text(),'Sunil K')])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='pt_nm'])[1]")).sendKeys("Cucum");
		Thread.sleep(2000);
		// search
		...
		driver.findElement(By.xpath("(//a[@data-tooltip='Edit Cost'])[1]/i[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='activity_cost_field'])[1]")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//input[@id='activity_cost_field'])[1]")).sendKeys("0");
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//input[@id='activity_cost_field'])[1]")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//input[@id='activity_cost_field'])[1]")).sendKeys("400");
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//div[@class='user_detl_dropdown'])[1]/a[1]/i[1]")).click();
		Thread.sleep(3000);
		// closing the popup
		driver.findElement(By.xpath("(//div[@id='ConfirmIP'])[1]/div[1]/div[1]/span[1]/i[1]")).click();
		Thread.sleep(3000);

		// clicking on the billing and selecting the bypass carers
		driver.findElement(By.xpath("(//a[@id='admin-billing-tab'])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@id='bypass_carers'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//label[text()='Zone'])[1]/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Delhi'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Manager'])[1]/preceding-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[contains(text(),'Sunil K')])[1]")).click();
	...
	public void switching_role_to_nursing_officer_and_search_and_download_the_sheet() throws Exception {
		...
		driver.findElement(By.xpath("(//a[@class='brand-logo'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//div[normalize-space(text())='Nursing Officer'])[1]")).click();
		Thread.sleep(5000);
		...
		driver.findElement(By.xpath("(//input[@id='pt_nm'])[1]")).sendKeys("Cucum");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Payment status'])[1]/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='Approved'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@value='Search'])[1]")).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//a[@id='carer_activity'])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//label[text()='Carer name'])[1]/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[contains(text(),'Sunil K')])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='pt_nm'])[1]")).sendKeys("Cucum");
		...
		driver.findElement(
				...
				.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//i[@data-tooltip='Schedules'])[1]")).click();
		Thread.sleep(2000);
	...
	public void switch_role_to_finance_and_change_status_to_pay_from_approve() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//div[normalize-space(text())='Finance - nanohealthplan'])")).click();
		Thread.sleep(3000);
		...
		Thread.sleep(5000);
		// pay
		driver.findElement(By.xpath("(//span[text()='Pay'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//input[@value='Yes'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//label[text()='Zone'])[1]/preceding-sibling::span[1]")).click();
		...
		driver.findElement(By.xpath("(//label[text()='Payment status'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Paid'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='from-date'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//button[text()='1'])[1]")).click();

...
@CucumberOptions(features = {"src/test/java/Doctor/IPflow.feature"}, tags = "@admit", publish = true, glue = { "StepDefinitions",
		"Doctor", "Pharmacy", "Superadmin" ,"Homecareattendant"}, plugin = { "html:target/Cucumberreport.html" })

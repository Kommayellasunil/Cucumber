...
public class Masterdata {
	...
	public void add_the_address_contact_and_save_again() throws Exception {
		...
		//		WebElement element6 = driver.findElement(By.xpath("(//option[text()='Cucum Hospital (Hospital)'])[1]"));
	...
	public void enter_the_details_select_the_end_date() throws Exception {
		...
		driver.findElement(By.cssSelector("input#program_master_program_name")).sendKeys("Cucumber demandprogramme");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Category'])[1]/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='Impact'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#program_master_program_comp")).sendKeys("Testing company");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#program_master_program_owner")).sendKeys("Test owner");
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(2000);
		...
		newprogram.click();
		Thread.sleep(5000);
		driver.findElement(By.cssSelector("input#location_name")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#location_name")).sendKeys("loc_cucumdemandprogram");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//label[normalize-space(text())='City']/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='Hyderabad'])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("input#pincode")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//label[normalize-space(text())='Area']/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[contains(text(),'Nagar_1')])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("input#pincode")).sendKeys("898989");
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@value='Save'])[2]")).click();
		Thread.sleep(5000);
		driver.findElement(By.cssSelector("textarea#program_master_desc")).sendKeys("Test description");
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#program_master_start_dt")).click();
		Thread.sleep(2000);
	...
	public void edit_and_save_the_demandprogram_by_changing_the_programname() throws Exception {
		...
		Thread.sleep(3000);
		// changing the name
		driver.findElement(By.cssSelector("input#program_master_program_name")).clear();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#program_master_program_name")).sendKeys("Cucumber program");
		Thread.sleep(1000);
		// selecting the end-date
		driver.findElement(By.cssSelector("input#program_master_end_at")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//div[@class='select-wrapper select-year'])[1]/input[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li/span[text()='2035'])[1]")).click();
		Thread.sleep(1000);
	...
	public void click_on_the_doctors_button() throws Exception {
		...
		//		action.moveToElement(driver.findElement(By.id("admin-reports"))).click().build().perform();
		//		Thread.sleep(1000);
		//		action.moveToElement(driver.findElement(By.xpath("(//a[text()='Master Data'])[1]"))).click().build().perform();
		//		Thread.sleep(3000);
	...
	public void click_on_the_continue_button_to_add_doctor_role_in_the_next_popup() throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("input#upload_img")).sendKeys("C:\\Users\\Admin\\Desktop\\Automationuploadfile\\Doctor.png");
		Thread.sleep(2000);
	...
	public void select_the_role_and_existing_hospital_from_the_dropdown() throws Exception {
		driver.findElement(By.xpath("(//label[normalize-space(text())='Role'])[1]/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
		//		driver.findElement(By.xpath("(//li[text()='Doctor'])[1]")).click();
		//		Thread.sleep(2000);
		WebElement nameField = driver.findElement(By.xpath(
	...
	public void clicking_on_the_more_icon_to_enable_access_checkboxes() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Specialisations'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		...
		isnetwork.click();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#days_in_advnce")).sendKeys(Keys.PAGE_DOWN);
		Thread.sleep(1000);
		// entering the qualification of the doctor
		driver.findElement(By.xpath("(//textarea[@id='name_template'])[1]")).click();
		// (//textarea[@id='name_template'])[1]
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//textarea[@id='name_template'])[1]"))
		.sendKeys("MBBS, test qualification" + Keys.ENTER);
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//textarea[@id='name_template'])[1]")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//textarea[@id='name_template'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//textarea[@id='name_template'])[1]"))
	...
	public void click_on_the_add_or_edit_consultations_plus_button() throws Exception {
		// edit doctor
		driver.findElement(By.cssSelector("input#q_nmbr_cont")).sendKeys("7766554422");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@value='Search'])[1]")).click();
		Thread.sleep(3000);
	...
	public void add_appointment_types_for_the_created_doctor() throws Exception {
		...
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[contains(text(),'Clinic')])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Fee'])[1]/following-sibling::input[1]"))
		.sendKeys("300");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(
		...
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[1]/following-sibling::span[1]"))
		.click();
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.findElement(By.xpath("(//li[text()='Wednesday'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.findElement(By.xpath("(//li[text()='Thursday'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.findElement(By.xpath("(//li[text()='Friday'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.findElement(By.xpath("(//li[text()='Saturday'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.findElement(By.xpath("(//li[text()='Sunday'])[1]")).click();
		Thread.sleep(1000);
		// removing last added day
		driver.findElement(By.xpath("(//span[@class='select2-selection__choice__remove'])[7]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.findElement(By.xpath("(//li[text()='Saturday'])[1]")).click();
		...
		// start time
		driver.findElement(By.xpath("(//input[@placeholder='Available Start Time'])[1]")).click();
		Thread.sleep(1000);
		// 9
		...
		Thread.sleep(1000);
		// end time
		driver.findElement(By.xpath("(//input[@placeholder='Available End Time'])[1]")).click();
		Thread.sleep(1000);
		...
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[contains(text(),'Video')])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Fee'])[2]/following-sibling::input[1]"))
		.sendKeys("300");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(
		...
		Thread.sleep(1000);
		// clicking on the select days
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[2]/following-sibling::span[1]"))
		.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Monday'])[2]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[2]/following-sibling::span[1]"))
		.click();
		driver.findElement(By.xpath("(//li[text()='Friday'])[2]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[2]/following-sibling::span[1]"))
		.click();
		driver.findElement(By.xpath("(//li[text()='Saturday'])[2]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[2]/following-sibling::span[1]"))
		.click();
		driver.findElement(By.xpath("(//li[text()='Sunday'])[1]")).click();
		...
		// start time
		driver.findElement(By.xpath("(//input[@placeholder='Available Start Time'])[2]")).click();
		Thread.sleep(1000);
		// 9
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-hours'])[3]/div[9]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-minutes'])[1]/div[1]")).click();
		Thread.sleep(1000);
		// am
		driver.findElement(By.xpath("(//div[@class='timepicker-span-am-pm'])[3]/div[1]")).click();
		Thread.sleep(1000);
		// ok
		driver.findElement(By.xpath("(//div[@class='confirmation-btns'])[3]/button[2]")).click();
		Thread.sleep(1000);
		// end time
		driver.findElement(By.xpath("(//input[@placeholder='Available End Time'])[2]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-hours'])[3]/div[11]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-minutes'])[2]/div[1]")).click();
		Thread.sleep(1000);
		// am
		driver.findElement(By.xpath("(//div[@class='timepicker-span-am-pm'])[4]/div[2]")).click();
		Thread.sleep(1000);
		// ok
		driver.findElement(By.xpath("(//div[@class='confirmation-btns'])[4]/button[2]")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		// clicking on the select days
		driver.findElement(By.xpath("(//label[normalize-space(text())='Select Days'])[3]/following-sibling::span[1]"))
		.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Tuesday'])[2]")).click();
		Thread.sleep(1000);

		// start time
		driver.findElement(By.xpath("(//input[@placeholder='Available Start Time'])[3]")).click();
		Thread.sleep(1000);
		// 10
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-hours'])[5]/div[10]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-minutes'])[1]/div[1]")).click();
		Thread.sleep(1000);
		// am
		driver.findElement(By.xpath("(//div[@class='timepicker-span-am-pm'])[5]/div[1]")).click();
		Thread.sleep(1000);
		// ok
		driver.findElement(By.xpath("(//div[@class='confirmation-btns'])[5]/button[2]")).click();
		Thread.sleep(1000);
		// end time
		driver.findElement(By.xpath("(//input[@placeholder='Available End Time'])[3]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-hours'])[5]/div[11]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-minutes'])[2]/div[1]")).click();
		Thread.sleep(1000);
		// am
		driver.findElement(By.xpath("(//div[@class='timepicker-span-am-pm'])[6]/div[2]")).click();
		Thread.sleep(1000);
		// ok
		driver.findElement(By.xpath("(//div[@class='confirmation-btns'])[6]/button[2]")).click();
		Thread.sleep(1000);
		// save
		driver.findElement(By.xpath("(//input[@id='saveBtn'])[1]")).click();
		Thread.sleep(12000);
	...
	public void adding_charge_configurations_to_the_newly_added_doctors() throws Exception {
		// searching doctor
		driver.findElement(By.cssSelector("input#q_nmbr_cont")).clear();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#q_nmbr_cont")).sendKeys("7766554422");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@value='Search'])[1]")).click();
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[text()='Price'])[2]/following-sibling::input[1]")).sendKeys("30");
		Thread.sleep(3000);
		// save
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(5000);
	...
	public void adding_doctor_break_time_for_schedule_once() throws Exception {
		...
		driver.findElement(By.xpath("(//input[@value='Search'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//a[@data-tooltip='Add Block Day'])[1]/img[1]")).click();
		Thread.sleep(5000);
		// adding block days for schedule = once
		driver.findElement(By.xpath("(//label[normalize-space(text())='Hospital'])[1]/following-sibling::span[1]"))
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='NanoHealth_OPD'])[1]")).click();
		Thread.sleep(1000);
		...
		once.click();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#block_start_date")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//td[@class='is-today'])[1]/following-sibling::td[1]/button[1]")).click();
		Thread.sleep(2000);
		// save
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(5000);
		// edit & update the block date for schedule once
		driver.findElement(By.xpath("(//div[@id='block_apmnt_tab_Clinic'])[1]/table[1]/tbody[1]/tr[1]/td[6]/a[1]/i[1]"))
		.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='block_start_date'])[2]")).click();
		Thread.sleep(2000);
	...
	public void adding_doctor_break_time_for_schedule_dialy() throws Exception {
		...
		repeat.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[normalize-space(text())='Days'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Daily'])[1]")).click();
		Thread.sleep(2000);
		// start date
		driver.findElement(By.xpath("(//input[@id='block_start_date'])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//td[@class='is-today'])[1]/button[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='block_end_date'])[1]")).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//div[@id='block_apmnt_tab_Clinic'])[1]/table[1]/tbody[1]/tr[2]/td[6]/a[2]/i[1]"))
		.click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//input[@id='block_start_date'])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//td[@class='is-today is-selected'])[1]/button[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='block_end_date'])[1]")).click();
		Thread.sleep(2000);
		// Store all date elements in a list
	...
	public void adding_doctor_break_time_for_schedule_weekyly() throws Exception {
		...
		driver.findElement(By.xpath("(//label[normalize-space(text())='Week Days'])[1]/following-sibling::span[1]"))
		.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//label[normalize-space(text())='Week Days'])[1]/following-sibling::span[1]"))
		.click();
	...
	public void adding_doctor_break_time_for_schedule_monthly() throws Exception {
		...
		driver.findElement(By.xpath("(//label[normalize-space(text())='Days'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Monthly'])[1]")).click();
		Thread.sleep(2000);
		// selecting the month days
		driver.findElement(By.xpath("(//label[normalize-space(text())='Month Days'])[1]/following-sibling::span[1]"))
		.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//li[text()='1'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Month Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		...
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='3'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Month Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		...
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='6'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Month Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='25'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Month Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='26'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Month Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='27'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Month Days'])[1]/following-sibling::span[1]"))
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='28'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Month Days'])[1]/following-sibling::span[1]"))
		.click();
		Thread.sleep(2000);
	...
	public void adding_doctor_block_time_for_schedule_monthly() throws Exception {
		...
		.perform();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@data-tooltip='Add Break Time'])[1]/img[1]")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("(//label[normalize-space(text())='Hospital'])[1]/following-sibling::span[1]"))
		.click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		...
		// break start date
		driver.findElement(By.xpath("(//input[@id='break_start_date'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//td[@class='is-today'])[1]")).click();
		Thread.sleep(2000);
		// break enddate
		driver.findElement(By.xpath("(//input[@id='break_end_date'])[1]")).click();
		Thread.sleep(2000);
		// next month
		for (int i = 0; i <= 2; i++) {
			driver.findElement(By.xpath("(//button[@class='month-next'])[2]")).click();
		...
		Thread.sleep(2000);
		// break start time
		driver.findElement(By.xpath("(//input[@id='break_start_time'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-hours'])[1]/div[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-minutes'])[1]/div[7]")).click();
		Thread.sleep(1000);
		driver.findElement(
		...
		// break end time
		driver.findElement(By.xpath("(//input[@id='break_end_time'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-hours'])[1]/div[2]")).click();
		Thread.sleep(1000);
	...
	public void search_the_recent_added_doctor_using_search_field() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//a[text()='Facility Digital Twin'])[1]")).click();
		Thread.sleep(18000);
		// clicking on the user details
		driver.findElement(By.xpath("(//div[text()='User Details'])[1]")).click();
		Thread.sleep(5000);
	...
	public void click_on_the_add_button_to_add_a_new_dietician_master() throws Exception {
		...
		//		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// age
		driver.findElement(By.cssSelector("input#age")).sendKeys("36");
		Thread.sleep(1000);
		...
		.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//label[normalize-space(text())='Role'])[2]/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[contains(text(), 'Diet')])[1]")).click();
		Thread.sleep(2000);
		// selecting the existing hospital
		driver.findElement(By.xpath("//label[normalize-space(text())='Hospitals']/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		...
		Thread.sleep(8000);
		// edit dietitian
		driver.findElement(By.cssSelector("input#q_mobile_or_email_cont")).sendKeys("7788992222");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@value='Search'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//i[@class='fa fa-pencil'])[1]")).click();
	...
	public void click_on_the_dietitian_role_name_and_add_availability() throws Exception {
		...
		driver.findElement(By.xpath("(//a[@class='user_role_name' and contains(text(), 'Diet')])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//a[text()='Availability'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//i[text()='add'])[2]")).click();
		...
		driver.findElement(By.xpath("(//li[contains(text(),'Clinic')])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Fee'])[1]//preceding-sibling::input[1]"))
		.sendKeys("200");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(
		...
		driver.findElement(By.xpath("(//li[contains(text(),'Video')])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[normalize-space(text())='Fee'])[2]/preceding-sibling::input[1]"))
		.sendKeys("300");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(
	...
	public void add_price_configuration_for_the_newly_created_dietitian() throws Exception {
		...
		driver.findElement(By.xpath("(//span[text()='Dietician Consultation'])[1]")).click();
		Thread.sleep(5000);
		// searching dietitian
		...
		driver.findElement(By.xpath("(//label[text()='Price'])[2]/following-sibling::input[1]")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[text()='Price'])[2]/following-sibling::input[1]")).sendKeys("100");
		Thread.sleep(3000);
		// save
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(5000);
	...
	public void add_pharmacist_user_using_created_pharmacy_from_hospital_digital_twin() throws Exception {
		...
		.build().perform();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//div[@title='Add Pharmacist/Technician/Manager'])")).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.cssSelector("input#age")).sendKeys("30");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#email")).sendKeys("cucumpharmacist@gmail.com");
		Thread.sleep(2000);
		Robot tab = new Robot();
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//label[normalize-space(text())='Pharmacies']/following-sibling::span[1]"))
		.click();
		Thread.sleep(1000);
	...
	public void disconnect_the_pharmacy_with_the_hospital() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//button[@id='bold'])[1]/img[1]")).click();
		Thread.sleep(1000);
		// yes
		driver.findElement(By.xpath("(//button[text()='Yes'])[1]")).click();
		Thread.sleep(3000);
	...
	public void add_the_lab_address_and_save_it() throws Exception {
		...
		Thread.sleep(1000);
		// address line1
		driver.findElement(By.xpath("(//label[@id='HospitalLabel'])[6]/following-sibling::div/input")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[@id='HospitalLabel'])[6]/following-sibling::div/input"))
		.sendKeys("test one");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// address line2
		driver.findElement(By.xpath("(//label[@id='HospitalLabel'])[7]/following-sibling::div/input")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		...
		Thread.sleep(1000);
		// area
		driver.findElement(By.xpath("(//label[@id='HospitalLabel'])[10]/following-sibling::div/input")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[@id='HospitalLabel'])[10]/following-sibling::div/input"))
		.sendKeys("test area");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// landmark
		driver.findElement(By.xpath("(//label[@id='HospitalLabel'])[11]/following-sibling::div/input")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[@id='HospitalLabel'])[11]/following-sibling::div/input"))
		.sendKeys("test landmark");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// pincode
		driver.findElement(By.xpath("(//label[@id='HospitalLabel'])[12]/following-sibling::div/input")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
	...
	public void add_the_op_price_charge_configurations_from_opd_hospital() throws Exception {
		...
		driver.findElement(By.xpath("(//label[normalize-space(text()='Test Name')])[1]/following-sibling::span[1]"))
		.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='RBS'])[1]")).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//label[text()='Hospital'])[2]/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='NanoHealth_OPD'])[1]")).click();
		Thread.sleep(1000);
		// entering charge code
	...
	public void add_the_ip_price_charge_configurations_from_ipd_hospital() throws Exception {
		...
		driver.findElement(By.xpath("(//li[contains(text(), 'Insurance')])[1]")).click();
		Thread.sleep(1000);
	...
	public void add_the_op_and_ip_price_charge_configurations_from_cdpadmin_role() throws Exception {
		...
		//		Thread.sleep(1000);
		//		// entering charge code
		//		driver.findElement(By.xpath("(//label[text()='Charge Code'])[3]/following-sibling::input[1]"))
		//				.sendKeys("rbs-op");
		//		Thread.sleep(1000);
		...
		//		driver.findElement(By.xpath("(//li[text()='MSNL1-Rudraram'])[1]")).click();
		//		Thread.sleep(1000);
		//		driver.findElement(By.xpath("(//label[text()='Payment Mode'])[3]/following-sibling::span[1]")).click();
		//		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		//		driver.findElement(By.xpath("(//li[text()='Self'])[1]")).click();
		//		Thread.sleep(1000);
		//		// entering the flat increase amount
		//		driver.findElement(By.xpath("(//label[text()='Flat Increase'])[3]/following-sibling::input[1]")).clear();
		//		Thread.sleep(1000);
		//		driver.findElement(By.xpath("(//label[text()='Flat Increase'])[3]/following-sibling::input[1]"))
		...
		//		driver.findElement(By.xpath("(//a[text()='IP Charge Price Configurations'])[1]")).click();
		//		Thread.sleep(2000);
		...
		//		WebElement element3 = driver.findElement(By.xpath("(//option[text()='Cucum Lab (Lab)'])[1]"));
		//		jse51.executeScript("arguments[0].click();", element3);
		//		Thread.sleep(3000);
		//		// mouse hovering on to the hospital
		//		Actions action111 = new Actions(driver);
		//		action111.moveToElement(driver.findElement(By.xpath("(//div[text()='Cucum Lab'])[1]"))).build().perform();
		//		Thread.sleep(3000);
		//		Actions action311 = new Actions(driver);
		//		action311.moveToElement(driver.findElement(By.xpath("(//div[text()='Diagnostic Test'])[1]"))).build().perform();
		//		Thread.sleep(2000);
	...
	public void add_the_interpretation_for_the_profile_test_and_save_it() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[contains(text(),'Thyroid Profile')])[1]")).click();
		Thread.sleep(1000);
		// search
		driver.findElement(By.xpath("(//input[@value='Search'])[1]")).click();
		Thread.sleep(3000);
		// clicking on the interpretation button
		driver.findElement(By.xpath("(//i[@class='fa fa-comment fa-solid'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.cssSelector("textarea#interpretation")).sendKeys(
	...
	public void selecting_the_test_name_from_the_dropdown_to_add_into_the_popular_package() throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//label[@for='order_id'])[1]/following-sibling::input[1]")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(By.xpath("(//label[@for='order_id'])[1]/following-sibling::input[1]"))
		.sendKeys("0" + Keys.TAB);
		Thread.sleep(1000);
		// clicking on the dropdown
		//		driver.findElement(By.xpath("(//label[text()='Test Name'])[2]/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(By.xpath("(//li[text()='MRI Spectroscopy'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	}
	...
	public void clicking_on_the_plus_button_to_select_one_more_test1() throws Exception {
		// add
		driver.findElement(By.xpath("(//div[@id='addButton'])[1]/a[1]")).click();
		Thread.sleep(1000);
	}
	...
	public void entering_the_order_number1() throws Exception {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(By.xpath("(//label[@for='order_id'])[2]/following-sibling::input[1]"))
		.sendKeys("1" + Keys.TAB);
		Thread.sleep(1000);
	}
	...
	public void selecting_the_test_name1_from_the_dropdown_to_add_into_the_popular_package() throws Exception {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(By.xpath("(//li[text()='Cross Match'])[1]")).click();
		Thread.sleep(1000);
	}
	...
	public void clicking_on_the_plus_button_to_select_one_more_test2() throws Exception {
		driver.findElement(By.cssSelector("input#diagnostic_test_lab_detail_test_name")).click();
		Thread.sleep(2000);
		Robot robot = new Robot();
		robot.keyPress(KeyEvent.VK_PAGE_DOWN);
		Thread.sleep(2000);
	...
	public void entering_the_order_number2() throws Exception {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(By.xpath("(//label[@for='order_id'])[3]/following-sibling::input[1]"))
		.sendKeys("2" + Keys.TAB);
		Thread.sleep(1000);
	}
	...
	public void selecting_the_test_name2_from_the_dropdown_to_add_into_the_popular_package() throws Exception {
		driver.findElement(By.xpath("(//label[@for='order_id'])[3]/following-sibling::input[1]")).sendKeys(Keys.DOWN);
		Thread.sleep(1000);
		// clicking on the dropdown
	...
	public void entering_the_order_number3() throws Exception {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(By.xpath("(//label[@for='order_id'])[4]/following-sibling::input[1]"))
		.sendKeys("3" + Keys.TAB);
		Thread.sleep(1000);
	}
	...
	public void adding_one_of_the_profiletest_in_package() throws Exception {
		...
		.sendKeys("4" + Keys.TAB);
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[contains(text(),'Lipid Profile')])[1]")).click();
		Thread.sleep(1000);
	}
	...
	public void mouse_hovering_to_the_tests_in_the_cucumber_testlab() throws Exception {
		...
		//					.visibilityOfElementLocated(By.xpath("(//span[@class='tooltipped childs_tests'])[1]/i[1]")));
		//
	...
	public void add_the_hospital_name_and_save_it() throws Exception {
		// add
		driver.findElement(By.xpath("(//div[@class='addressAdd'])[1]/a[1]")).click();
		Thread.sleep(1000);
	...
	public void add_lab_slots_for_the_newly_created_lab() throws Exception {
		driver.findElement(By.xpath("(//a[@data-tooltip='Slots'])[1]/i[1]")).click();
		Thread.sleep(3000);
		driver.findElement(
				By.xpath("(//label[normalize-space(text())='Appointment Type'])[1]/following-sibling::span[1]"))
		.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[contains(text(),'Lab')])[1]")).click();
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//li[text()='Sunday'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//span[@class='select2-selection__choice__remove'])[8]")).click();
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//table[@id='example'])[2]/tbody[1]/tr[1]/td[6]/a[1]/i[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='e_start_time'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='timepicker-dial timepicker-hours'])[3]/div[9]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//div[@class='confirmation-btns'])[3]/button[2]")).click();
		Thread.sleep(2000);
		// save
		driver.findElement(By.xpath("(//input[@class='btn green update_save'])[1]")).click();
		Thread.sleep(3000);
		// deleting one of the slot days
		driver.findElement(By.xpath("(//table[@id='example'])[2]/tbody[1]/tr[2]/td[6]/a[2]/i[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//button[text()='Confirm!'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//div[@id='slot-modal'])[1]/div[1]/div[1]/span[1]/i[1]")).click();
		Thread.sleep(2000);
	}
	...
	public void add_newly_created_popular_package_in_another_lab() throws Exception {
		...
		existing.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//span[@id='select2-diagnostic_test_master_select-container'])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//li[contains(text(),'Cucum')])[1]")).click();
		Thread.sleep(3000);
		...
		.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='diagnostic_test_lab_detail_cost'])[1]")).sendKeys("300");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='diagnostic_test_lab_detail_price'])[1]")).sendKeys("200");
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(5000);
	}
	...
	public void add_copy_as_popular_package_in_the_another_lab() throws Exception {
		...
		copyas.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//span[@id='select2-copy_diagnostic_test_master_select-container'])[1]")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='copy_pkg_test_name'])[1]"))
		.sendKeys("Copy as popular package" + Keys.TAB);
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//button[text()='Continue'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.cssSelector("input#diagnostic_test_lab_detail_cost")).sendKeys("100" + Keys.TAB);
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='diagnostic_test_lab_detail_price'])[1]")).sendKeys("100" + Keys.TAB);
		Thread.sleep(3000);
		// save
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(5000);
	...
	public void select_the_roles_technician_pathologist_and_save() throws Exception {
		driver.findElement(By.xpath("//label[normalize-space(text())='Role']/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Lab_Technician'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(
				By.xpath("//label[normalize-space(text())='DiagnosticLabMasters']/following-sibling::span[1]")).click();
		Thread.sleep(1000);
	...
	public void select_the_role_from_the_roles_popup_and_select_the_required_options_from_the_role_fields()
		...
		Thread.sleep(3000);
		// number
		driver.findElement(By.cssSelector("input#nmbr")).sendKeys("6566566560" + Keys.TAB);
		Thread.sleep(3000);
		// YES
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// number
		driver.findElement(By.cssSelector("input#nmbr")).sendKeys("6566566561" + Keys.TAB);
		Thread.sleep(3000);
		// continue
		driver.findElement(By.xpath("(//button[text()='Continue'])[1]")).click();
		Thread.sleep(3000);
	...
	public void select_the_another_role_and_role_required_options_from_the_dropdowns() throws Exception {
		driver.findElement(By.xpath("(//label[normalize-space(text())='Role'])[3]/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
		//		driver.findElement(By.xpath("(//li[text()='Doctor'])[1]")).click();
		//		Thread.sleep(3000);
		WebElement nameField = driver.findElement(By.xpath(
		...
		driver.findElement(By.xpath("(//li[text()='NanoHealth_OPD'])[2]")).click();
		Thread.sleep(1000);
	...
	public void add_the_ipbillingmanager_role_with_financial_access() throws Exception {
		...
		driver.findElement(By.xpath("(//i[text()='add'])[2]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//label[normalize-space(text())='Role'])[4]/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
		...
		nameField.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//img[@data-tooltip='More'])[3]")).click();
		Thread.sleep(2000);
		for (int i = 0; i <= 2; i++) {
	...
	public void select_the_role_as_healthcoach_from_the_dropdown() throws Exception {
		driver.findElement(By.xpath("//label[normalize-space(text())='Role']/preceding-sibling::span[1]\r\n" + ""))
		.click();
		Thread.sleep(1000);
	...
	public void select_the_city_and_area_from_the_dropdown() throws Exception {
		...
		driver.findElement(By.xpath("//label[normalize-space(text())='Zones']/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='NanoHealth_OPD'])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//label[text()='City'])[1]/following-sibling::span[1]")).click();
		...
		Thread.sleep(2000);
		// selecting the area
		driver.findElement(By.xpath("//label[normalize-space(text())='Areas']/following-sibling::span[1]")).click();
		Thread.sleep(2000);
	...
	public void download_the_profile_and_assign_device_and_assign_tablet() throws Exception {
		...
		Thread.sleep(2000);
		// device type
		driver.findElement(By.xpath("(//label[text()='Device Type'])[1]/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		...
		Thread.sleep(3000);
		// assign tablet
		driver.findElement(By.xpath("(//a[@data-tooltip='Enable provider app access'])[1]/img[1]")).click();
		Thread.sleep(2000);
		// app access
		for (int i = 0; i <= 1; i++) {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Role'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='HealthCoach'])[1]")).click();
		Thread.sleep(1000);
		// search
...
//		Thread.sleep(1000);
	...
	public void click_on_the_minor_procedures_from_the_dashboard() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#surgery_master_surgery_name")).sendKeys("Cucum dialysis");
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//span[text()='Minor Procedure'])[1]")).click();
		Thread.sleep(5000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//li[text()='Apollo Munich Health Insurance Company Limited'])[1]")).click();
		Thread.sleep(2000);
		// remove
	...
	public void after_creating_redirect_to_the_digitaltwin_and_mousehover_on_hospital_again() throws Exception {
		...
		driver.findElement(By.xpath("(//span[contains(text(),'Dialysis')])[1]")).click();
		Thread.sleep(8000);
	}
	...
	public void click_on_the_dialysis_and_map_created_dialysis_in_the_hospital() throws Exception {
		...
		driver.findElement(By.xpath("(//label[text()='Procedure'])[2]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[contains(text(),'Cucum dialysis')])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='hospital_surgery_mapping_master_price'])[1]")).sendKeys("100");
		Thread.sleep(1000);
		// save
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(8000);
		...
		driver.findElement(By.xpath("(//i[@class='fa fa-pencil'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//input[@id='hospital_surgery_mapping_master_price'])[1]")).clear();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='hospital_surgery_mapping_master_price'])[1]")).sendKeys("150");
		Thread.sleep(1000);
		// save
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(8000);
	...
	public void deleting_the_room_type_and_room_details_from_UI() throws Exception {
		...
		driver.findElement(By.xpath("(//span[text()='Room'])[1]")).click();
		Thread.sleep(5000);
		// clicking on the room type details
		driver.findElement(By.xpath("//a[text()='Room Type Details']")).click();
		Thread.sleep(1000);
	...
	public void click_on_save_button_from_the_edit_room_type_details_page() throws Exception {
		...
		driver.findElement(By.xpath("(//a[@data-tooltip='Add Room Type'])[1]/i")).click();
		Thread.sleep(1000);
		//		WebElement roomTypeInput = driver.findElement(By.cssSelector("input#clinic_room_type_master_room_type"));
		...
		driver.findElement(By.xpath("(//div[@id='room-type-modal'])[1]/div[1]/div[1]/span[1]/i[1]")).click();
		Thread.sleep(2000);
	}
	...
	public void click_on_the_save_button_from_the_edit_room_details_popup() throws Exception {
		...
		robot.keyPress(KeyEvent.VK_TAB);
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//div[@id='room-modal'])[1]/div[1]/div[1]/span[1]/i[1]")).click();
		Thread.sleep(5000);
		// hover the mouse on Reports
		Actions action = new Actions(driver);
		Thread.sleep(1000);
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//input[@id='brand_master_brand_name'])[1]")).sendKeys("Cucumber brandmaster");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		...
		driver.findElement(By.cssSelector("input#brand_master_brand_name")).clear();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#brand_master_brand_name")).sendKeys("Cucumber brandmaster' 1.5GM/8");
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//a[contains(text(), 'CUCUMBER')])[1]")).click();
		Thread.sleep(2000);
	...
	//		// mouse hovering on to the hospital
	//		Actions action = new Actions(driver);
	//		action.moveToElement(driver.findElement(By.xpath("(//div[text()='Cucum Pharmacy'])[1]"))).build().perform();
	//		Thread.sleep(3000);
	//		// clicking on the charge masters
	//		driver.findElement(By.xpath("(//div[text()='Brand Masters'])[1]")).click();
	//		Thread.sleep(5000);
	...
	public void click_on_the_diease_program_from_the_masterdata_dashboard() throws Exception {
		...
		Thread.sleep(3000);
		// clicking on the charge masters
		driver.findElement(By.xpath("(//span[text()='Package'])[1]")).click();
		Thread.sleep(5000);
	}
	...
	public void enter_the_package_duration_and_select_the_days_from_dropdown() throws Exception {
		...
		driver.findElement(By.cssSelector("input#duration")).sendKeys("365");
		Thread.sleep(1000);
	}
	...
	public void click_on_the_screening_camps_from_the_masterdata_dashboard() throws Exception {
		...
		driver.findElement(By.xpath("(//span[text()='Screening Camps'])[1]")).click();
		Thread.sleep(5000);
	}
	...
	public void entering_the_camp_name_to_create_new_camp() throws Exception {
		driver.findElement(By.xpath("(//label[text()='Camp Type'])[1]/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[contains(text(),'Camp')])[1]")).click();
		//		Robot robot = new Robot();
		...
		driver.findElement(By.cssSelector("input#camp_name")).sendKeys("Cucumber testcamp");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	}
	...
	public void select_the_location_from_the_dropdown() throws InterruptedException {
		...
		driver.findElement(By.xpath("(//label[text()='Location '])[1]/preceding-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	...
	public void select_the_service_from_the_dropdown() throws Exception {
		driver.findElement(By.xpath("(//label[text()='Service'])[1]/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
	...
	public void deleting_already_exisiting_patient_in_the_camp() throws Exception {
		...
		driver.findElement(By.xpath("(//div[normalize-space(text())='CDPAdmin'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("frst_nm")).sendKeys("5656565657");
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("(//a[text()='Cucumber testcamp'])[1]")).click();
		Thread.sleep(1000);
	...
	public void click_on_the_plus_button_to_assign_patients() throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='register_patient_data'])[1]")).sendKeys("7781110013");
		Thread.sleep(2000);
		// clicking search
		driver.findElement(By.xpath("(//input[@value='Search'])[2]")).click();
		Thread.sleep(2000);
	...
	public void add_patient_in_that_new_camp() throws Exception {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// phone
		driver.findElement(By.cssSelector("input#nmbr")).sendKeys("5656565657");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// email
	...
	public void click_on_the_device_management_from_the_masterdata() throws Exception {
		...
		Thread.sleep(3000);
		// clicking on the charge masters
		driver.findElement(By.xpath("(//span[text()='Device'])[1]")).click();
		Thread.sleep(5000);
	}
	...
	public void searching_with_the_avaible_dropdown() throws Exception {
		...
		driver.findElement(By.xpath("(//label[text()='Available'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//span[@class='selection'])[7]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Cucum Healthcoach'])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@value='Submit'])[1]")).click();
		Thread.sleep(2000);
	}
	...
	public void add_another_ques_and_made_it_dependent_parent_and_child_question() throws Exception {
		...
		//		Thread.sleep(2000);
		//		driver.findElement(By.xpath(
		//				"(//label/span[text()='Existing Question'])[1]/following-sibling::div[1]/div[1]/div[1]/div[2]/input[1]"))
		...
		WebElement source = driver.findElement(By.xpath("(//span[@title='Drag to reorder within row / drag to another row / drag to empty space to create new row'])[3]"));
		WebElement target = driver.findElement(By.xpath("(//span[@title='Drag to reorder within row / drag to another row / drag to empty space to create new row'])[1]"));
	...
	public void remove_the_last_question_from_the_creating_form() throws Exception {
		...
		lastque.moveToElement(
				driver.findElement(By.xpath("(//div[@class='que-input-area'])[6]"))).build()
		.perform();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//img[@alt='Delete'])[1]")).click();
		Thread.sleep(2000);
	...
	public void edit_the_form_add_the_newly_created_question_and_save_changes() throws Exception {
		...
		WebElement source1 = driver.findElement(By.xpath("(//span[@title='Drag to reorder within row / drag to another row / drag to empty space to create new row'])[6]"));
		WebElement target = driver.findElement(By.xpath("(//span[@title='Drag to reorder within row / drag to another row / drag to empty space to create new row'])[3]"));
		Actions clickandhold =new Actions(driver);
		clickandhold.clickAndHold(source1).build().perform();
		Thread.sleep(2000);
		clickandhold.dragAndDropBy(target, 0, -10).release().build().perform();
		...
		//		WebElement source11 = driver.findElement(By.xpath("(//span[@title='Drag to reorder within row / drag to another row / drag to empty space to create new row'])[6]"));
		//		WebElement target1 = driver.findElement(By.xpath("(//div[@class='questions-container'])[1]"));
	...
	public void enter_the_required_store_type_and_store_name() {
		// store type
		driver.findElement(By.xpath("(//label[@id='HospitalLabel'])[2]/following-sibling::div[1]/input[1]"))
		.sendKeys("Test store type");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// store name
		driver.findElement(By.xpath("(//label[@id='HospitalLabel'])[3]/following-sibling::div[1]/input[1]"))
	...
	public void search_the_store_and_click_on_the_edit_button() throws Exception {
		...
		//		Actions connection = new Actions(driver);
		//		connection.dragAndDrop(driver.findElement(By.xpath("(//div[@data-handleid='a'])[1]")), laststore1).build()
		//				.perform();
		//		Thread.sleep(2000);
		//
		//		// yes
...
//		Thread.sleep(3000);
		...
		.perform();
		Thread.sleep(18000);
		driver.findElement(By.xpath("(//div[text()='Department Masters'])[1]")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("(//i[text()='add'])[1]")).click();
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("(//input[@id='saveBtn'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//label[text()='Department Name'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//li[contains(text(),'Cucum')])[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@value='Search'])[1]")).click();
	...
	//	public void click_on_department_master_from_digitaltwin_dashboard() throws Exception {
	//		//		// clicking on the brand logo & changing role
	//		//		WebDriverWait logoclick = new WebDriverWait(driver, Duration.ofSeconds(30));
	//		//		logoclick
	//		//				.until(ExpectedConditions.visibilityOf(driver

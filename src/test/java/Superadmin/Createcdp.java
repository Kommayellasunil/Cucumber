...
//		driver.manage().window().maximize();
	...
	public void enter_email15_password15(String email15, String password15) throws Exception {
		...
		driver.findElement(By.id("user_login")).sendKeys(email15);
		driver.findElement(By.id("user_password")).sendKeys(password15);
		Thread.sleep(15000);
	}
...
//		Thread.sleep(5000);
	...
	public void enter_the_cdp_details_and_save_to_create_new_cdp() throws Exception {
		...
		driver.findElement(By.xpath("(//label[text()='CDP Type'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Hospitals'])[1]")).click();
		Thread.sleep(1000);
		// entering cdpname
		driver.findElement(By.cssSelector("input#care_delivery_program_master_name")).sendKeys("Cucum cdp");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#autocomplete-input")).sendKeys("Testing CDP");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#gst_no")).sendKeys("GSTIN12345");
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#btnClear")).click();
		Thread.sleep(2000);
		// selecting the cdp type
		driver.findElement(By.xpath("(//label[text()='CDP Type'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		...
		driver.findElement(By.cssSelector("input#org_name")).sendKeys("Cucumcdp");
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#gst_no")).sendKeys("GSTIN12345" + Keys.PAGE_DOWN);
		Thread.sleep(1000);
//		JavascriptExecutor js = (JavascriptExecutor) driver;
//		js.executeScript("window.scrollBy(0, 100)");
//		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#address_details_address_line1")).sendKeys("Test addressline1");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#address_details_address_line2")).sendKeys("Test addressline2");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#address_details_area")).sendKeys("Test area");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#address_details_landmark")).sendKeys("Test landamrk");
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#address_details_pin_code")).sendKeys("500035");
		Thread.sleep(1000);
//		js.executeScript("window.scrollBy(0, 100)");
//		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#contact_details_frst_nm")).sendKeys("Cucumcdp");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#contact_details_lst_nm")).sendKeys("user");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#contact_details_nmbr")).sendKeys("3456789012");
		Thread.sleep(2000);
		// save
	...
	public void dashboard_opens_search_created_cdp_using_filters_and_click_on_the_edit_button() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Created'])[1]")).click();
		Thread.sleep(1000);
		// search
	...
	public void in_edit_cdp_popup_add_details_of_enabled_roles_and_services_and_upload_headerfooterlogo()
		...
		Thread.sleep(1000);
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='CDPAdmin'])[1]")).click();
		Thread.sleep(1000);
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(
				By.xpath("(//label[normalize-space(text())='Enabled Roles'])[1]//preceding-sibling::span[1]")).click();
		...
		Thread.sleep(1000);
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[contains(text(),'Doctor Consultation')])[1]")).click();
		Thread.sleep(1000);
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(
				By.xpath("(//label[normalize-space(text())='Enabled Services'])[1]//preceding-sibling::span[1]"))
		...
		Thread.sleep(1000);
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[contains(text(),'Diagnostic Lab')])[1]")).click();
		Thread.sleep(2000);
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
//		JavascriptExecutor js = (JavascriptExecutor) driver;
//		js.executeScript("window.scrollBy(0, 100)");
		driver.findElement(By.cssSelector("input#care_delivery_program_master_name")).sendKeys(Keys.PAGE_DOWN);
		Thread.sleep(1000);
		// uploading web logo
...
//		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#gst_no")).sendKeys(Keys.PAGE_DOWN);
		Thread.sleep(2000);
	...
	public void click_on_the_save_button_to_save_the_changes_of_new_cdp() throws Exception {
		...
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("(//label[text()='CDP Name'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
...
//		driver.findElement(By.xpath("(//label[text()='Status'])[1]/following-sibling::span[1]")).click();
		...
		driver.findElement(By.xpath("(//li[@title='Doctor'])[1]/span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[contains(text(),'Diet')])[1]/span[1]")).click();
		Thread.sleep(1000);
		// save
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(3000);
...
//		Thread.sleep(1000);
	...
	public void enter_and_select_the_details_for_the_subscription_plan() throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//label[text()='Item'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Chakra Subscription(Monthly)'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("textarea#chakra_subscription_plan_label_description"))
		...
		driver.findElement(By.cssSelector("textarea#chakra_subscription_plan_label_description"))
				.sendKeys("testing desc");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Price type'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='One Time'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Billing day'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='5th'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Monthly'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Due on receipt'])[1]")).click();
		Thread.sleep(1000);
	}
	...
	public void edit_the_subscription_invoice_and_save_changes() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.cssSelector("input#chakra_subscription_plan_price")).clear();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#chakra_subscription_plan_price")).sendKeys("2000");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Billing day'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='10th'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@value='Submit'])[1]")).click();
		Thread.sleep(3000);
		// closing the popup
		driver.findElement(By.xpath("(//div[@id='subscription-modal'])[1]/div[1]/div[1]/span[1]/i[1]")).click();
		Thread.sleep(3000);
...
//		Thread.sleep(1000);
	...
	public void click_on_the_plus_button_to_setup_the_cdp() throws Exception {
		driver.findElement(By.xpath("(//a[@data-tooltip='Add New Invoice'])[1]/i[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//label[text()='Item'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
	}
	...
	public void select_the_setup_and_fillthe_details_and_submit_the_details() throws Exception {
		driver.findElement(By.xpath("(//li[text()='Setup'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#corp_sale_order_header_amount")).clear();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#corp_sale_order_header_amount")).sendKeys("5000");
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#corp_sale_order_header_amount")).clear();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#corp_sale_order_header_amount")).sendKeys("10000");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='corp_sale_order_header_due_date'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//td[@class='is-today'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Payment Terms'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Due on receipt'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//textarea[@id='comments'])[1]")).sendKeys("testing description");
		Thread.sleep(2000);
		// submit
		driver.findElement(By.xpath("(//input[@id='submit-btn'])[1]")).click();
		Thread.sleep(5000);
		...
		driver.findElement(By.xpath("(//a[text()='Save'])[1]")).click();
		Thread.sleep(5000);
		// clicking on the print invoice
//				Actions action = new Actions(driver);
		action.moveToElement(driver.findElement(By.xpath("(//a[@data-tooltip='Print Invoice'])[1]/img[1]"))).build()
...
//		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("(//label[text()='Status'])[1]/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Draft'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='q_due_date_time_gteq'])[1]")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@id='q_due_date_time_lteq'])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//td[@class='is-today'])[1]/button[1]")).click();
		Thread.sleep(2000);
		// search
...
//		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("(//a[text()='Hospitals'])[1]")).click();
		Thread.sleep(3000);
	...
	public void enter_all_the_necessary_details_for_creation_of_hospital() throws Exception {
		...
		action.moveToElement(driver.findElement(By.xpath("(//a[@data-tooltip='Add New Hospital'])[1]/i[1]"))).click()
				.build().perform();
		Thread.sleep(3000);
		driver.findElement(By.cssSelector("input#hospital_master_hsptl_nm")).sendKeys("Cucumcdp hospital");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//label[text()='Facility Type Master'])[1]/following-sibling::span[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.xpath("(//li[text()='OP Only'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#hospital_master_rgstrton_no")).sendKeys("1345677");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#hospital_master_rgstrton_yr")).sendKeys("2025");
		Thread.sleep(1000);
		// reset
		...
		driver.findElement(By.xpath("(//li[text()='OP Only'])[1]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#hospital_master_rgstrton_no")).sendKeys("1234567890");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#hospital_master_rgstrton_yr")).sendKeys("2022");
		Thread.sleep(1000);
		for (int i = 0; i <= 1; i++) {
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#address_details_address_line1")).sendKeys("test line1");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#address_details_address_line2")).sendKeys("test line2");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#address_details_landmark")).sendKeys("test lndmrk");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='City'])[1]/preceding-sibling::span[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//li[text()='Hyderabad'])[1]")).click();
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#hospital_master_nmbr")).sendKeys("8080818180");
		Thread.sleep(2000);
		// save
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(5000);
	...
	public void enter_the_necessary_details_for_doctor_creation() throws Exception {
		// doctor details
		driver.findElement(By.cssSelector("input#doctor_master_frst_nm")).sendKeys("Cucumcdp");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#doctor_master_lst_nm")).sendKeys("doctor");
		Thread.sleep(1000);
		WebElement male = driver.findElement(By.xpath("(//label[text()='M'])[1]"));
		male.click();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#age")).sendKeys("65");
		Thread.sleep(1000);
		WebElement smsngmail = driver.findElement(By.xpath("(//label[text()='SMS and Email'])[1]"));
		smsngmail.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='nmbr'])[1]")).sendKeys("4848484848");
		Thread.sleep(1000);
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		jse.executeScript("window.scrollBy(0, 200);");
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//li[contains(text(),'Cucum')])[1]")).click();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#doctor_master_qualification")).sendKeys("1234567890");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#doctor_master_rgstrton_no")).sendKeys("1234567890");
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#doctor_master_rgstrton_no")).sendKeys(Keys.PAGE_DOWN);
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("input#doctor_master_rgstrton_yr")).sendKeys("2022");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#doctor_master_hospital_doctors_time_sensivity")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#doctor_master_hospital_doctors_time_sensivity")).sendKeys("1");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));

		driver.findElement(By.cssSelector("input#doctor_master_hospital_doctors_days_in_advnce")).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#doctor_master_hospital_doctors_days_in_advnce")).sendKeys("30");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//label[text()='Specialisations'])/following-sibling::span[1]")).click();
		Thread.sleep(1000);
		...
		jse.executeScript("window.scrollBy(0, 200);");
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input#doctor_master_hospital_doctors_effctv_dt")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//td[@class='is-today'])[1]")).click();
		Thread.sleep(2000);
		// save
	...
	public void create_cdpadmin_user_from_admins_button() throws Exception {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		driver.findElement(By.cssSelector("input#lst_name")).sendKeys("Cdpadmin");
		Thread.sleep(1000);
		 ...
		 */
		driver.findElement(By.cssSelector("input#age")).sendKeys("55");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='nmbr'])[1]")).sendKeys("4848484849" + Keys.TAB);
		Thread.sleep(2000);
		// continue
...
//		Thread.sleep(2000);
		...
		driver.findElement(By.cssSelector("input#q_frst_nm_or_lst_nm_cont")).sendKeys("Cucum");
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@value='Search'])[1]")).click();
		Thread.sleep(5000);
		// edit cdpadmin
		driver.findElement(By.xpath("(//i[@class='fa fa-pencil'])[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//input[@id='user_role_details_label_name'])[1]")).clear();
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@id='user_role_details_label_name'])[1]")).sendKeys("CDPadmin");
		Thread.sleep(2000);
		// save
		driver.findElement(By.xpath("(//input[@value='Save'])[1]")).click();
		Thread.sleep(5000);
		...
		driver.findElement(By.cssSelector("input#user_password")).sendKeys("Chakra@1");
		Thread.sleep(1000);
		// share
